codeunit 134920 "ERM General Journal UT"
{
    ...
    begin
        ...
        // [GIVEN] "Document Type" = Invoice, "Document No." = "Z1", "Account Type" = Vendor, "Account No." = 10000, "Bal. Account No." = "Y"
        // [GIVEN] "Document Type" = Invoice, "Document No." = "Z2", "Account Type" = Vendor, "Account No." = 20000, "Bal. Account No." = "Y"
        // [GIVEN] "Document Type" = Invoice, "Document No." = "Z3", "Account Type" = Vendor, "Account No." = 20000, "Bal. Account No." is blank
        // [GIVEN] "Document Type" = Invoice, "Document No." = "Z3", "Account Type" = G/LAccount, "Account No." = Y, "Bal. Account No." is blank
    ...
    begin
        ...
        // [THEN] The "Document No." has been renumbered in the following way
        // [GIVEN] "Document Type" = Invoice, "Document No." = "Z1", "Account Type" = Vendor, "Account No." = 10000, "Bal. Account No." = "Y"
        // [GIVEN] "Document Type" = Invoice, "Document No." = "Z1", "Account Type" = G/LAccount, "Account No." = Y, "Bal. Account No." is blank
        // [GIVEN] "Document Type" = Invoice, "Document No." = "Z2", "Account Type" = Vendor, "Account No." = 20000, "Bal. Account No." = "Y"
        // [GIVEN] "Document Type" = Invoice, "Document No." = "Z2", "Account Type" = G/LAccount, "Account No." = Y, "Bal. Account No." is blank
        GenJournalLine[1].Find();
        GenJournalLine[1].TestField("Document No.", NewDocNo);
        GenJournalLine[2].Find();
        GenJournalLine[2].TestField("Document No.", NewDocNo);
