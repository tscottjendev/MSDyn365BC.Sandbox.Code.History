...
table 312 "Purchases & Payables Setup"
{
    ...
    fields
    {
        ...
        field(12101; "Temporary Bill List No."; Code[20])
        {
            Caption = 'Temporary Bill List No.';
            TableRelation = "No. Series";
        }
        field(12177; "VAT Exemption Nos."; Code[20])
        {
            Caption = 'VAT Exemption Nos.';
            TableRelation = "No. Series";
        }
        field(12178; "Prevent Posted Doc. Deletion"; Boolean)
        {
