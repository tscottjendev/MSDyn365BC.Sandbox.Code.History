...
table 312 "Purchases & Payables Setup"
{
    ...
    fields
    {
        ...
        field(11320; "Check Doc. Total Amounts"; Boolean)
        {
            ...
            ToolTip = 'Specifies if you want the Doc. Amount Incl. VAT field in Purchase Invoice and Purchase Credit Memo to be compared to the sum of the VAT amounts fields in the purchase lines. If the amounts are not the same, you will be notified when posting the document.';
        }
        field(11610; "GST Prod. Posting Group"; Code[20])
        {
            Caption = 'GST Prod. Posting Group';
            TableRelation = "VAT Posting Setup"."VAT Prod. Posting Group";
        }
        field(11611; "Pre-GST Prod. Posting Group"; Code[20])
        {
            Caption = 'Pre-GST Prod. Posting Group';
            TableRelation = "VAT Posting Setup"."VAT Prod. Posting Group";
        }
        field(11612; "Vendor Registration Warning"; Boolean)
        {
            Caption = 'Vendor Registration Warning';
        }
        field(11613; "Payment Discount Reason Code"; Code[10])
        {
        ...
        field(28041; "Print Dialog"; Boolean)
        {
            Caption = 'Print Dialog';
        }
        field(28042; "Print WHT Docs. on Pay. Post"; Boolean)
        {
            Caption = 'Print WHT Docs. on Pay. Post';
        }
        field(28043; "Print WHT Docs. on Credit Memo"; Boolean)
        {
            Caption = 'Print WHT Docs. on Credit Memo';
        }
        field(28070; "Posted Tax Invoice Nos."; Code[20])
        {
            Caption = 'Posted Tax Invoice Nos.';
            TableRelation = "No. Series";
        }
        field(28071; "Posted Tax Credit Memo Nos"; Code[20])
        {
            Caption = 'Posted Tax Credit Memo Nos';
            TableRelation = "No. Series";
        }
        field(28072; "Posted Non Tax Invoice Nos."; Code[20])
        {
            Caption = 'Posted Non Tax Invoice Nos.';
            TableRelation = "No. Series";
        }
        field(28073; "Posted Non Tax Credit Memo Nos"; Code[20])
        {
            Caption = 'Posted Non Tax Credit Memo Nos';
            TableRelation = "No. Series";
        }
        field(28087; "Enable Vendor GST Amount (ACY)"; Boolean)
        {
            Caption = 'Enable Vendor GST Amount (ACY)';
        }
        field(28090; "Post Dated Check Template"; Code[10])
        {
            Caption = 'Post Dated Check Template';
            TableRelation = "Gen. Journal Template";
        }
        field(28091; "Post Dated Check Batch"; Code[10])
        {
        ...
        field(28093; "Default Cancel Reason Code"; Code[10])
        {
