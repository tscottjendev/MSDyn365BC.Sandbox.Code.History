    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Outstanding Order Stat. by PO")
            {
                ...
                ToolTip = 'View detailed outstanding order information printed by purchase order number. Business Central includes shipping information, quantities ordered, and the amount back ordered.';
            }
