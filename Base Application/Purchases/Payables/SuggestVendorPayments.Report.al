...
#pragma warning restore AA0470
    ...
    begin
        ...
        if GenJnlLine2."Bank Payment Type" = GenJnlLine2."Bank Payment Type"::"Electronic Payment" then
            ElectPmtsManagement.GetTransferType(GenJnlLine."Account No.", GenJnlLine.Amount, GenJnlLine."Transfer Type", false);
        ...
        if VendLedgEntry3.Get(TempVendorPaymentBuffer."Vendor Ledg. Entry No.") then begin
            GenJnlLine."Applies-to Bill No." := VendLedgEntry3."Bill No.";
            if VendLedgEntry3."Recipient Bank Account" <> '' then
                GenJnlLine."Recipient Bank Account" := VendLedgEntry3."Recipient Bank Account";
        end;
    ...
    begin
        ...
        PaymentGenJournalLine.SetRange("Applies-to Bill No.", VendorLedgerEntry."Bill No.");
