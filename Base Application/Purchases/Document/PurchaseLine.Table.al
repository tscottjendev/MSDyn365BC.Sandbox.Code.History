    ...
    fields
    {
        ...
        field(6; "No."; Code[20])
        {
            ...
            begin
                ...
                if VATPostingSetup.IsEUService("VAT Bus. Posting Group", "VAT Prod. Posting Group") then
                    "Service Tariff No." := PurchHeader."Service Tariff No."
                else
        ...
        field(15; Quantity; Decimal)
        {
            ...
            begin
                ...
                if ("Prod. Order No." <> '') and (Type = Type::Item) and ("No." <> '') then
            ...
            begin
                ...
                if not IsHandled then begin
                    ...
                    if CurrFieldNo = FieldNo("VAT Prod. Posting Group") then begin
                        ...
                        VendLedgEntry.SetRange("Document No.", PurchHeader."Last Prepayment No.");
                        VendLedgEntry.SetRange(Prepayment, true);
                        VendLedgEntry.SetRange(Open, true);
                        if VendLedgEntry.FindFirst() then
                            Error(Text1130000, FieldCaption("VAT Prod. Posting Group"));
                    end;
...
#pragma warning restore
        ...
        field(12132; "Related Entry No."; Integer)
        {
            ...
            var
                ...
                CAVendor: Record "Customs Authority Vendor";
            begin
                TestField("Buy-from Vendor No.");
                Vendor.Get("Buy-from Vendor No.");
                if Vendor.IsCustomAuthorityVendor() then
                    Validate("Related Entry No.", Vendor.LookupEntryNo("Related Entry No."))
                else
        ...
        field(12139; "Prepmt. CM Refers to Period"; Option)
        {
            ...
            trigger OnValidate()
            begin
                if "Prepmt. CM Refers to Period" = "Prepmt. CM Refers to Period"::" " then
                    if "Prepmt. Line Amount" <> 0 then
                        Error(Text12106, FieldCaption("Prepmt. CM Refers to Period"), FieldCaption("Prepmt. Line Amount"));
            end;
        }
...
#pragma warning disable AA0470
        ...
        Text1130000: Label 'Quantity not present on subcontractor location.';
        Text12106: Label 'The %1 field can only be blank when %2 = 0.';
#pragma warning restore AA0470
#pragma warning restore AA0074
    ...
    begin
        ...
        "Refers to Period" := PurchHeader."Refers to Period";
    ...
    begin
        ...
        if ("Prepayment %" <> 0) and (Type <> Type::" ") then begin
            ...
            if "Prepmt. CM Refers to Period" = "Prepmt. CM Refers to Period"::" " then
                if PurchHeader."Prepmt. CM Refers to Period" = PurchHeader."Prepmt. CM Refers to Period"::" " then
                    "Prepmt. CM Refers to Period" := "Prepmt. CM Refers to Period"::Current
                else
                    "Prepmt. CM Refers to Period" := PurchHeader."Prepmt. CM Refers to Period";
        end else
            "Prepmt. CM Refers to Period" := "Prepmt. CM Refers to Period"::" ";
    end;
                    ...
                    then begin
                        if NonDeductibleVAT.IsNonDeductibleVATEnabled() then
                            VATAmountLine.InsertNewLine(
                                PurchLine."VAT Identifier", PurchLine."VAT Calculation Type", PurchLine."Tax Group Code", PurchLine."Use Tax", PurchLine."VAT %", PurchLine."Line Amount" >= 0, false, 100 - PurchLine."Non-Deductible VAT %")
                        else
                            VATAmountLine.InsertNewLine(
                                PurchLine."VAT Identifier", PurchLine."VAT Calculation Type", PurchLine."Tax Group Code", PurchLine."Use Tax", PurchLine."VAT %", PurchLine."Line Amount" >= 0, false, PurchLine."Deductible %");
    ...
    [Scope('OnPrem')]
    procedure GetQtyPerUOM(): Decimal
    var
    ...
    begin
        ...
        if Country.CheckNotEUCountry(PurchHeader."VAT Country/Region Code") and
