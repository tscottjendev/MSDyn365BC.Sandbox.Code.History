...
table 271 "Bank Account Ledger Entry"
{
    ...
    keys
    {
        ...
        key(Key8; "Source Code", "Posting Date", "Document No.")
        {
        }
        key(Key9; "Source Code", "Document No.", "Posting Date")
        {
        }
        key(Key10; "Bank Account No.", "Posting Date", "Source Code")
        {
        }
        key(Key11; "Bank Account No.", "Document No.", "Posting Date")
        {
        }
        key(key12; "Statement No.", "Statement Line No.")
        {
        }
    }
