        ...
        area(content)
        {
            ...
            group(Payee)
            {
                ...
                fixed(Control1902115401)
                {
                    ...
                    {
                        Caption = 'Amount';
                        field("CheckAmount + WHTAmount"; CheckAmount + WHTAmount)
                        {
                            ApplicationArea = Basic, Suite;
                ...
                field(Control1500007; Text002)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
                field(Control1500006; Text002)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
                field(Control1500005; Text002)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
                field(CheckAmount; CheckAmount)
                {
                    ...
                    AutoFormatExpression = Rec."Currency Code";
                    AutoFormatType = 1;
                    CaptionClass = Format('Total ' + Rec."Currency Code");
                    Caption = 'CheckAmount';
                    ToolTip = 'Specifies the total amount on this check.';
                }
                field(Control1500010; Text002)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
                field(Control1500009; Text002)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
                field(Control1500008; Text002)
                {
                    ApplicationArea = Basic, Suite;
                    Visible = false;
                }
