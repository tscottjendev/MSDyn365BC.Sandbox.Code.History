...
page 370 "Bank Account Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group(Posting)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the version code used by the CODA system to import coded bank account statements.';
                }
            ...
            group(Transfer)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the interbank clearing code for this bank account.';
                }
    ...
    actions
    {
            ...
            group("&Bank Acc.")
            {
                ...
                group("COD&A")
                {
                    ...
                    action("&Import CODA File")
                    {
                        ...
                        Image = Import;
                        ToolTip = 'Import a CODA statement file that you have received from your bank.';
        ...
        area(processing)
        {
            ...
            action("CODA Statements")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'CODA Statements';
                Image = "Report";
                RunObject = Page "CODA Statement List";
                RunPageLink = "Bank Account No." = field("No.");
                RunPageView = sorting("Bank Account No.", "Statement No.");
        ...
        area(Promoted)
        {
            group(Category_Process)
            {
                ...
                actionref("CODA Statements_Promoted"; "CODA Statements")
                {
                }
                actionref(PagePosPayExport_Promoted; PagePosPayExport)
                {
                }
                actionref("&Import CODA File_Promoted"; "&Import CODA File")
                {
                }
            }
