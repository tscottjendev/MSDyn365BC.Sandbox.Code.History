    ...
    layout
    {
        area(content)
        {
            ...
            group(Transfer)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the Corporate Banking Customer Unique Code.';
                }
    ...
    actions
    {
        area(navigation)
        {
            group("&Bank Acc.")
            {
                ...
                action("Bill &Posting Group")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Bill &Posting Group';
                    Image = GeneralPostingSetup;
                    RunObject = Page "Bill Posting Group";
                    RunPageLink = "No." = field("No.");
                    ToolTip = 'View or edit the list of bill posting groups.';
                }
                separator(Action81)
                {
                }
