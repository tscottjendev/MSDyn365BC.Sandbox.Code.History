...
table 5200 Employee
{
    ...
    fields
    {
        ...
        field(3; "Second Family Name"; Text[30])
        {
            Caption = 'Second Family Name';
        }
        field(4; "First Family Name"; Text[30])
        {
        ...
        field(10701; "Middle Name"; Text[30])
        {
            Caption = 'Second Family Name';
        }
        field(10702; "Last Name"; Text[30])
        {
            Caption = 'First Family Name';
        }
    }
    ...
    keys
    {
        ...
        key(Key5; "First Family Name", Name, "Second Family Name")
        {
        }
    }
    ...
    [Scope('OnPrem')]
    procedure UpdateNamesFromOldFields()
    begin
        if Name <> '' then
            "First Name" := Name;
        if "First Name" <> '' then
        ...
        if "Second Family Name" <> '' then
            "Middle Name" := "Second Family Name";
        if "Middle Name" <> '' then
            "Second Family Name" := "Middle Name";

        if "First Family Name" <> '' then
            "Last Name" := "First Family Name";
        if "Last Name" <> '' then
