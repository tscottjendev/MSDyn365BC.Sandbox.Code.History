...
table 263 "Intrastat Jnl. Line"
{
    ...
    fields
    {
        ...
        field(10700; "Place of Receipt"; Text[25])
        {
        ...
        field(10702; "Shipment Method Code #2"; Option)
        {
            ...
            InitValue = "1-Internal";
            OptionCaption = ' ,1-Internal,2-Another EU Country/Region,3-Others (outside EU)';
            OptionMembers = " ","1-Internal","2-Another EU Country/Region","3-Others (outside EU)";
        }
