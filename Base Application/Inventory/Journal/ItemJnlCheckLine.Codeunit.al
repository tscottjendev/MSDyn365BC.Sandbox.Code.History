...
#pragma warning restore AA0074
    ...
    begin
        ...
        if TransportMethod.Get(ItemJournalLine."Transport Method") and TransportMethod."Port/Airport" then
            ItemJournalLine.TestField("Entry/Exit Point", ErrorInfo.Create());
