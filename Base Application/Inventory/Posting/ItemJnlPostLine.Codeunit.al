...
#pragma warning restore AA0074
    ...
    begin
        ...
        ItemLedgEntry."Customer No." := ItemJnlLine."Customer No.";
        ItemLedgEntry."Ship-to Address Code" := ItemJnlLine."Ship-to Address Code";
        ItemLedgEntry."Customer Salesperson Code" := ItemJnlLine."Customer Salesperson Code";
    ...
    begin
        if TableNo in [Database::"Item Ledger Entry", Database::"Item Register", Database::"Value Entry",
                       Database::"Capacity Ledger Entry", Database::"Phys. Inventory Ledger Entry",
