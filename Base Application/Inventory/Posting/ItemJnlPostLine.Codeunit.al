    ...
    begin
        ...
        repeat
            ...
            if StartApplication then begin
                ...
                if Vendor.Get(OldItemLedgEntry."Source No.") then
                    if Vendor.Subcontractor and (Vendor."Subcontracting Location Code" <> '') then
                        SubcontractorTransfer := true;
