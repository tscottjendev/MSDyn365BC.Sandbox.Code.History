...
#pragma warning restore AA0074
    ...
    [Scope('OnPrem')]
    procedure CalcFAPostedOriginalAcqCostAmount(FANo: Code[20]; Period: Option "Before Starting Date","Net Change","at Ending Date"; StartingDate: Date; EndingDate: Date; DeprBookCode: Code[10]): Decimal
    var
        FALedgEntry: Record "FA Ledger Entry";
    begin
        if EndingDate = 0D then
