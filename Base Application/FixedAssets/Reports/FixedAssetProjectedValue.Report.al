...
report 5607 "Fixed Asset - Projected Value"
{
    ...
    dataset
    {
        dataitem("Fixed Asset"; "Fixed Asset")
        {
            ...
            column(GroupAmounts5; GroupAmounts[5])
            {
                AutoFormatType = 1;
            }
            ...
            column(ComponentofMainAsset_FixedAsset; "Component of Main Asset")
            {
            }
            ...
            column(FAProjectedValueCaption; FAProjectedValueCaptionLbl)
            {
            }
            column(FAPostingDateCaption; FAPostingDateCaptionLbl)
            {
            }
            column(BookValueCaption; BookValueCaptionLbl)
            {
            }
            column(AnticipatedCaption; AnticipatedCaptionLbl)
            {
            }
            column(AcceleratedReducedCaption; AcceleratedReducedCaptionLbl)
            {
            }
            column(AmountCaption; AmountCaptionLbl)
            {
            }
            column(NoofDepreDaysCaption; NoofDepreDaysCaptionLbl)
            {
            }
            column(FAPostingTypeCaption; FAPostingTypeCaptionLbl)
            {
            }
            dataitem("FA Ledger Entry"; "FA Ledger Entry")
            {
                DataItemTableView = sorting("FA No.", "Depreciation Book Code", "FA Posting Date");
                column(FAPostingDate_FALedgerEntry; Format("FA Posting Date"))
                {
                }
                column(FAPostingType_FALedgerEntry; "FA Posting Type")
                {
                }
                column(FALedgerEntryAmount; Amount)
                {
                }
                ...
                column(NoofDepreDays_FALedgerEntry; "No. of Depreciation Days")
                {
                }
                column(EntryNo_FALedgerEntry; "FA Ledger Entry"."Entry No.")
                {
                }
                column(PostedEntryCaption; PostedEntryCaptionLbl)
                {
                }
            ...
            dataitem(ProjectedDepreciation; "Integer")
            {
                ...
                column(EntryAmounts1Custom1Amount; EntryAmounts[1] - Custom1Amount)
                {
                    AutoFormatType = 1;
                }
                ...
                column(Custom1AmountLOC; Custom1Amount)
                {
                }
                column(Custom2AmountLOC; Custom2Amount)
                {
                }
                column(Custom1Text1; Custom1Text)
                {
                }
                ...
                column(FixedAssetDescription1; "Fixed Asset".Description)
                {
                }
                ...
                column(AssetAmounts5; AssetAmounts[5])
                {
                    AutoFormatType = 1;
                }
                column(AssetAmounts1AssetAmounts2; AssetAmounts[1] + AssetAmounts[2])
                {
                    AutoFormatType = 1;
                }
                column(DeprCustom1Text1; DeprCustom1Text)
                {
                }
                ...
                column(SalesPriceFieldname2; SalesPriceFieldname)
                {
                }
                column(GainLossFieldname1; GainLossFieldname)
                {
                }
        ...
        dataitem(ProjectionTotal; "Integer")
        {
            ...
            column(ProjectedDisposal1; ProjectedDisposal)
            {
            }
            column(DeprBookUseCustom1Depr2; DeprBook."Use Custom 1 Depreciation")
            {
            }
            ...
            column(TotalAmounts5; TotalAmounts[5])
            {
                AutoFormatType = 1;
            }
            column(Custom1Text3; Custom1Text)
            {
            }
            column(DeprCustom1Text2; DeprCustom1Text)
            {
            }
            column(TotalAmounts1TotalAmounts2; TotalAmounts[1] + TotalAmounts[2])
            {
                AutoFormatType = 1;
            }
            column(SalesPriceFieldname1; SalesPriceFieldname)
            {
            }
            column(GainLossFieldname2; GainLossFieldname)
            {
            }
        ...
        dataitem(Buffer; "Integer")
        {
            ...
            column(DeprBookText1; DeprBookText)
            {
            }
            column(Custom1Text2; Custom1Text)
            {
            }
            ...
            column(BufferFAPostingDateCaption; BufferFAPostingDateCaptionLbl)
            {
            }
            column(FAProjectionDepreCaption; FAProjectionDepreCaptionLbl)
            {
            }
            column(FAProjectedValueCaption1; FAProjectedValueCaption1Lbl)
            {
            }
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(UseCustom1; UseCustom1)
                    {
                        ...
                        ToolTip = 'Specifies if you want to include anticipated depreciation.';
                    }
                    field(UseCustom2; UseCustom2)
                    {
                        ApplicationArea = FixedAssets;
                        Caption = 'Use Acc./Red. Depr.';
                        ToolTip = 'Specifies if you want to include accelerated and reduced depreciation.';
                    }
                }
            }
        }
    ...
    var
        ...
        GroupAmounts: array[5] of Decimal;
...
#pragma warning restore AA0470        
        ...
        AnticipatedCaptionLbl: Label 'Anticipated';
        AcceleratedReducedCaptionLbl: Label 'Accelerated/ Reduced';
        AmountCaptionLbl: Label 'Amount';
        NoofDepreDaysCaptionLbl: Label 'No. of Depreciation Days';
        FAPostingTypeCaptionLbl: Label 'FA Posting Type';
        PostedEntryCaptionLbl: Label 'Posted Entry';
        TotalCaptionLbl: Label 'Total';
        ProjectedAmtspecDtCaptionLbl: Label 'Projected Amounts per Date';
        BufferFAPostingDateCaptionLbl: Label 'FA Posting Date';
        FAProjectionDepreCaptionLbl: Label 'Depreciation';
        FAProjectedValueCaption1Lbl: Label 'Fixed Asset - Projected Value';
    ...
    var
        ...
        CodeName: Code[20];
    begin
        EntryAmounts[1] := EntryAmounts[1] + DeprAmount + Custom1Amount + Custom2Amount;
        if Custom1DeprUntil > 0D then
            if UntilDate <= Custom1DeprUntil then
                EntryAmounts[4] := EntryAmounts[4] + DeprAmount + Custom1Amount + Custom2Amount;
        EntryAmounts[2] := EntryAmounts[2] + Custom1Amount;
        EntryAmounts[3] := EntryAmounts[3] + DeprAmount + Custom1Amount + Custom2Amount;
        AssetAmounts[1] := AssetAmounts[1] + DeprAmount;
        AssetAmounts[2] := AssetAmounts[2] + Custom1Amount;
        AssetAmounts[5] := AssetAmounts[5] + Custom2Amount;
        GroupAmounts[1] := GroupAmounts[1] + DeprAmount;
        GroupAmounts[2] := GroupAmounts[2] + Custom1Amount;
        GroupAmounts[5] := GroupAmounts[5] + Custom2Amount;
        ...
        TotalAmounts[5] := TotalAmounts[5] + Custom2Amount;
        TotalBookValue[1] := TotalBookValue[1] + DeprAmount + Custom1Amount + Custom2Amount;
        TotalBookValue[2] := TotalBookValue[2] + DeprAmount + Custom1Amount + Custom2Amount;
        if BudgetNameCode <> '' then
