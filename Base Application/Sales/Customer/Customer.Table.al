...
#pragma warning restore AS0086
        ...
        field(12121; "Individual Person"; Boolean)
        {
        ...
        field(12125; "Date of Birth"; Date)
        {
        ...
        field(12170; "Cumulative Bank Receipts"; Boolean)
        {
        ...
        field(12171; "Exposure (LCY)"; Decimal)
        {
            CalcFormula = sum("Detailed Cust. Ledg. Entry"."Amount (LCY)" where("Customer No." = field("No."),
                                                                                 ...
                                                                                 "Bank Receipt" = filter(true),
                                                                                 "Currency Code" = field("Currency Filter"),
                                                                                 "Initial Entry Global Dim. 1" = field("Global Dimension 1 Filter"),
                                                                                 "Initial Entry Global Dim. 2" = field("Global Dimension 2 Filter")));
            Caption = 'Exposure (LCY)';
            Editable = false;
            FieldClass = FlowField;
        }
        field(12172; "Exposure Filter"; Date)
        {
            Caption = 'Exposure Filter';
            FieldClass = FlowFilter;
        }
        field(12173; "PA Code"; Code[7])
        {
            Caption = 'PA Code';
        }
