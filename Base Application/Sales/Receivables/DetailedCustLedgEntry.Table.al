...
table 379 "Detailed Cust. Ledg. Entry"
{
    ...
    fields
    {
        ...
        field(12102; "Bank Receipt"; Boolean)
        {
    ...
    keys
    {
        ...
        key(Key11; "Customer No.", "Document Type", "Bank Receipt", "Bank Receipt Issued")
        {
            SumIndexFields = "Amount (LCY)";
        }
        key(Key12; "Customer No.", "Initial Entry Due Date", "Initial Document Type", "Bank Receipt", "Bank Receipt Issued")
        {
            SumIndexFields = "Amount (LCY)";
        }
        ...
        key(Key15; "Initial Document Type", "Initial Entry Due Date")
        {
            SumIndexFields = "Amount (LCY)";
        }
