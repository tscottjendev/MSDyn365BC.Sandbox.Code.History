...
page 459 "Sales & Receivables Setup"
{
    ...
    layout
    {
        area(content)
        {
            ...
            {
                Caption = 'Documents';
                field("KID Setup"; Rec."KID Setup")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the format of the Kunde ID (KID) number on the giro part of a sales document.';
                }
                field("Document No. length"; Rec."Document No. length")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of digits used for specifying the document number in the KID number.';
                }
                field("Customer No. length"; Rec."Customer No. length")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of digits used for specifying the customer no. in the KID number.';
                }
                field("Use KID on Fin. Charge Memo"; Rec."Use KID on Fin. Charge Memo")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if you want to print Kunde ID (KID) numbers on the Finance Charge Memo.';
                }
                field("Use KID on Reminder"; Rec."Use KID on Reminder")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if you want to print Kunde ID (KID) numbers on the Reminder.';
                }
            }
            group("E-Invoice")
            {
