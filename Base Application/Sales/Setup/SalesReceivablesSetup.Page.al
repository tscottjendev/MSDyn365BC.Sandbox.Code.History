    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Shipment on Ship and Invoice"; Rec."Shipment on Ship and Invoice")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Automatic recalculate Quotes"; Rec."Automatic recalculate Quotes")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies that all quote lines will be recalculated automatically.';
                }
                ...
                field("Apply Inv. Round. Amt. To VAT"; Rec."Apply Inv. Round. Amt. To VAT")
                {
                    ApplicationArea = Basic, Suite;
