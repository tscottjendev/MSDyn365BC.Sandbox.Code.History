    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Prevent Posted Doc. Deletion"; Rec."Prevent Posted Doc. Deletion")
                {
                    ApplicationArea = Basic, Suite;
                    Importance = Additional;
                    ToolTip = 'Specifies if posted sales documents can be deleted. If you select this check box, posted sales documents cannot be deleted.';
                }
                ...
                field("Fattura PA Electronic Format"; Rec."Fattura PA Electronic Format")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the electronic document format code for the Fattura PA.';
                }
            ...
            group("Number Series")
            {
                ...
                field("VAT Exemption Nos."; Rec."VAT Exemption Nos.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series code used for sales and receivables VAT exemptions.';
                }
                ...
                field("Fattura PA Nos."; Rec."Fattura PA Nos.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series for Fattura payments.';
                }
            }
            ...
            {
                Caption = 'Bills';
                field("Temporary Bill List No."; Rec."Temporary Bill List No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the numbers series code used to assign temporary numbers to customer bill lists.';
                }
                field("Bank Receipts Risk Period"; Rec."Bank Receipts Risk Period")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies a formula that will tell the program how to calculate the risk period.';
                }
                field("Recall Bill Description"; Rec."Recall Bill Description")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies a default description for the G/L ledger entries that will be created while reversing an issued customer bill.';
                }
            }
            group(Archiving)
            {
