    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the reason code that will be used by default when you use the Cancel function on a posted sales invoice. Use the Create Corrective Credit Memo function if you want to set reason code manually.';
                }
            ...
            group("WHT/GST")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if we want WHT certificates to be printed.';
                }
                field("Print Dialog"; Rec."Print Dialog")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if we do not want to use the default printer during printing of reports.';
                }
                field("Payment Discount Reason Code"; Rec."Payment Discount Reason Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the Reason Code the system tags against each Payment Journal where a Payment Discount is automatically calculated.';
                }
            ...
            group("Post Dated Checks")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the post-dated checks are to be included in Cr. Limit Check.';
                }
            }
            group(Archiving)
            {
