    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Post Invoice Discount"; Rec."Post Invoice Discount")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies to post the invoice discount to a separate account.';
                }
                field("Post Line Discount"; Rec."Post Line Discount")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies to post the line discount to a separate account.';
                }
                field("Post Payment Discount"; Rec."Post Payment Discount")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Correct. Doc. No. Mandatory"; Rec."Correct. Doc. No. Mandatory")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the document number correction is required, for the electronic payment to be made.';
                }
