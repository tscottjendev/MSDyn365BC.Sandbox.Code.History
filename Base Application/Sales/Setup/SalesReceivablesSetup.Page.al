        ...
        area(content)
        {
            ...
            group(Printing)
            {
                ...
                group(Control1050005)
                {
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Single Copy Sales Invoices';
                    }
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'If invoices are to be printed in a single copy, a statement to that effect should be sent to the Director of Internal Revenue. Such a statement can be printed by clicking the button below.';
                    }
                }
            }
            group(Archiving)
