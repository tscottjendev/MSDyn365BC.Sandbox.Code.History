    ...
    layout
    {
        area(content)
        {
            ...
            group("Adjustment Details")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies that if this field is set to yes, then the transaction is known as an Adjustment transaction.';
                }
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies this is the Document that the Adjustment was applied to.';
                }
            ...
            group(Billing)
            {
                ...
                group("Bill-to")
                {
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        ToolTip = 'Specifies that the tax document type is assigned here from the Customer.';
                    }
