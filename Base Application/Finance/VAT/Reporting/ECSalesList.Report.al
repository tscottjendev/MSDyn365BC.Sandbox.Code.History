        ...
        dataitem("Country/Region"; "Country/Region")
        {
            ...
            dataitem("VAT Entry"; "VAT Entry")
            {
                ...
                begin
                    ...
                    TotalEUTrdPartyAmtService += Round(EUTrdPartyAmtService, 0.01);
                    TotalNotEUTrdPartyAmtService += Round(NotEUTrdPartyAmtService, 0.01);
                    TotalEUTrdPartyAmt += Round(EUTrdPartyAmt, 0.01);
                    TotalNotEUTrdPartyAmt += Round(NotEUTrdPartyAmt, 0.01);
...
#pragma warning restore AA0074
    ...
    var
        TextAmt: Text[30];
    begin
        TextAmt := Format(Round(-AmountToPrint, 0.01), 0, '<Precision,2:2><Integer Thousand><Decimals>');
