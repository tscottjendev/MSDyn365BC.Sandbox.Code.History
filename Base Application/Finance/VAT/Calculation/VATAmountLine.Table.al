...
table 290 "VAT Amount Line"
{
    ...
    fields
    {
        ...
        field(12103; "Nondeductible Base"; Decimal)
        {
            AutoFormatType = 1;
            Caption = 'Nondeductible Base';
            Editable = false;
        }
        field(12104; "Nondeductible Amount"; Decimal)
        {
            AutoFormatType = 1;
            Caption = 'Nondeductible Amount';
            Editable = false;
        }
        field(12105; "Unrealized Base"; Decimal)
        {
            AutoFormatType = 1;
            Caption = 'Unrealized Base';
        }
        field(12106; "Unrealized Amount"; Decimal)
        {
            AutoFormatType = 1;
            Caption = 'Unrealized Amount';
        }
        field(12110; "VAT Description"; Text[50])
        {
            CalcFormula = lookup("VAT Identifier".Description where(Code = field("VAT Identifier")));
            Caption = 'VAT Description';
...
#pragma warning restore AA0470
    ...
    begin
        ...
        if NonDeductibleVAT.IsNonDeductibleVATEnabled() then
            Rec."Non-Deductible VAT %" := 100 - DeductiblePercent
        else
            Rec."Deductible %" := DeductiblePercent;
        Rec.Insert();
    end;
#endif
    ...
    begin
        ...
        if FindSet() then
            repeat
                ...
                "Nondeductible Base" := "VAT Base" * (100 - "Deductible %") / 100;
    ...
    begin
        ...
        "Deductible %" := PurchInvLine."Deductible %";
    ...
    begin
        ...
        "Deductible %" := PurchCrMemoLine."Deductible %";
    ...
    begin
        ...
        "Deductible %" := SalesInvoiceLine."Deductible %";
