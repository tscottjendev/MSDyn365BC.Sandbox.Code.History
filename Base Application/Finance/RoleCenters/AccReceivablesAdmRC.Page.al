...
page 9003 "Acc. Receivables Adm. RC"
{
    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Customer - Address List")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Customer - Address List';
                Image = "Report";
                RunObject = Report "Customer - Address List";
                ToolTip = 'View the address for each of your customers.';
            }
            action("Customer - Balance")
            {
                ...
                ToolTip = 'View the balance for customers that you select with a total for each customer posting group, in local currency. The report is useful at the close of an accounting period or fiscal year.';
            }
            ...
            separator(Action1080002)
            {
            }
            action("Customer - Open Entries")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Customer - Open Entries';
                Image = "Report";
                RunObject = Report "Customer - Open Entries";
                ToolTip = 'View all the open customer ledger entries.';
            }
            ...
            action("Cust. Ledger Entries on Hold")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Cust. Ledger Entries on Hold';
                Image = "Report";
                RunObject = Report "Cust. Ledger Entries on Hold";
                ToolTip = 'View all the customer ledger entries which have the On Hold field selected in the Cust. Ledger Entry table. The report is useful for viewing invoiced amounts that are on hold.';
            }
