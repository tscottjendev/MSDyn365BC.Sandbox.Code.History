    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Customer Bills List")
            {
                ...
                ToolTip = 'View the list of customer bills.';
            }
            separator(Action20)
            {
            }
        ...
        area(embedding)
        {
            ...
            action("Issued Customer Bills")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Issued Customer Bills';
                RunObject = Page "List of Issued Cust. Bills";
                ToolTip = 'View the issued customer bills.';
            }
        ...
        area(processing)
        {
            ...
            action("Calculate Interest on Arrears")
            {
                ...
                ToolTip = 'Calculate the interest on arrears for customer or vendor transactions';
            }
            separator(Action1130008)
            {
            }
            action("Issuing Customer Bill")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Issuing Customer Bill';
                Image = "Report";
                RunObject = Report "Issuing Customer Bill";
                ToolTip = 'Create and issue customer bills.';
            }
