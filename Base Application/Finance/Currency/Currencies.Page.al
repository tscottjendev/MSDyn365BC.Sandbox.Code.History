    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Bill Groups - Collection"; Rec."Bill Groups - Collection")
                {
                    ApplicationArea = Suite;
                    ToolTip = 'Specifies a check mark to accept receivable bill groups in the corresponding currency.';
                }
                field("Bill Groups - Discount"; Rec."Bill Groups - Discount")
                {
                    ApplicationArea = Suite;
                    ToolTip = 'Specifies a check mark to accept discounted bill groups in the corresponding currency.';
                }
                field("Payment Orders"; Rec."Payment Orders")
                {
                    ApplicationArea = Suite;
                    ToolTip = 'Specifies a check mark to accept payment orders in the corresponding currency.';
                }
