...
table 98 "General Ledger Setup"
{
    ...
    fields
    {
        ...
        field(12103; "Last Gen. Jour. Printing Date"; Date)
        {
            Caption = 'Last Gen. Jour. Printing Date';
            Editable = false;
        }
        field(12104; "Last General Journal No."; Integer)
        {
            Caption = 'Last General Journal No.';
        }
        ...
        {
            Caption = 'Last Settlement Date';
        }
        field(12120; "Last Printed G/L Book Page"; Integer)
        {
            Caption = 'Last Printed G/L Book Page';
            MinValue = 0;
        }
        field(12121; "CashVAT Product Posting Group"; Code[20])
        {
            Caption = 'CashVAT Product Posting Group';
            TableRelation = "VAT Product Posting Group".Code;
        }
        field(12122; "Company Officials Nos."; Code[20])
        {
            Caption = 'Company Officials Nos.';
            TableRelation = "No. Series";
        }
        field(12125; "VAT Settlement Period"; Option)
        {
            Caption = 'VAT Settlement Period';
...
#pragma warning disable AA0470
        ...
        Text12100: Label 'To change value of %1 all VAT Entries must be closed.';
        Text12101: Label 'To change value of %1 all Periodic VAT Settlement Entries must be closed.';
#pragma warning restore AA0470
    ...
    begin
        if xRec."VAT Settlement Period" <> "VAT Settlement Period" then begin
            ...
            VatEntry.SetCurrentKey(Type, Closed);
