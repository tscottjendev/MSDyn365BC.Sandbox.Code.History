...
table 98 "General Ledger Setup"
{
    ...
    fields
    {
        ...
        field(57; "Local Address Format"; Option)
        {
            ...
            OptionCaption = 'Post Code+City,City+Post Code,City+County+Post Code,Blank Line+Post Code+City,City+Post Code (no comma),City+County+Post Code (no comma),,,,,,,,Custom';
            OptionMembers = "Post Code+City","City+Post Code","City+County+Post Code","Blank Line+Post Code+City","City+Post Code (no comma)","City+County+Post Code (no comma)",,,,,,,,Custom;
        }
        ...
        field(11603; "Adjustment Mandatory"; Boolean)
        {
            Caption = 'Adjustment Mandatory';
            Editable = true;
        }
        ...
        field(11605; "Enable IRD No."; Boolean)
        {
            Caption = 'Enable IRD No.';
        }
        field(11606; "Enable VAT Registration No."; Boolean)
        {
        ...
        field(28000; "Address Validation"; Option)
        {
            ...
            OptionCaption = 'Post Code & City,Entire Address,Address ID';
            OptionMembers = "Post Code & City","Entire Address","Address ID";
        }
        field(28001; "AMAS Software"; Integer)
        {
            Caption = 'AMAS Software';
        }
        field(28002; "BarCode Custom Information"; Option)
        {
            Caption = 'BarCode Custom Information';
            OptionCaption = ' ,Code,Global Dimension 1 Code,Global Dimension 2 Code';
            OptionMembers = " ","Code","Global Dimension 1 Code","Global Dimension 2 Code";
        }
        ...
        field(28043; "Enable WHT"; Boolean)
        {
            Caption = 'Enable WHT';
        }
        field(28044; "Enable Tax Invoices"; Boolean)
        {
            Caption = 'Enable Tax Invoices';
        }
        field(28045; "Print Tax Invoices on Posting"; Boolean)
        {
        ...
        field(28047; "Min. WHT Calc only on Inv. Amt"; Boolean)
        {
            Caption = 'Min. WHT Calc only on Inv. Amt';
        }
        field(28048; "Force Payment With Invoice"; Boolean)
        {
            Caption = 'Force Payment With Invoice';
        }
        field(28090; "Post Dated Journal Template"; Code[10])
        {
            Caption = 'Post Dated Journal Template';
            TableRelation = "Gen. Journal Template";
        }
        field(28091; "Post Dated Journal Batch"; Code[10])
        {
        ...
        field(28092; "Interest Cal Excl. VAT"; Boolean)
        {
            Caption = 'Interest Cal Excl. VAT';
        }
        field(28093; "GST Report"; Boolean)
        {
            Caption = 'GST Report';
        }
    }
...
#pragma warning disable AA0470
        ...
        Text1500000: Label '%1 must be set to %2 if %3 is set to %4.';
        Text1500001: Label '%1 company is already set as %2.';
...
#pragma warning restore AA0470
    ...
    procedure GSTEnabled(DateToCheck: Date): Boolean
    begin
        if DateToCheck <> 0D then
            exit((DateToCheck >= 20000701D) and "Enable GST (Australia)")
        else
            exit("Enable GST (Australia)");
    end;

    [Scope('OnPrem')]
    procedure IRDNoEnabled(): Boolean
    begin
        exit("Enable IRD No.");
    end;

    [Scope('OnPrem')]
    procedure VATRegistrationNoEnabled(): Boolean
    begin
