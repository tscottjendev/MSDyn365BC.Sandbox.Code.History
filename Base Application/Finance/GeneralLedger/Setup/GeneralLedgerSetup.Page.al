    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Payment Discount Type"; Rec."Payment Discount Type")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies which type of Payment Discount best fits your needs.';
                }
                field("Discount Calculation"; Rec."Discount Calculation")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies how the discount will be calculated for this entry.';
                }
                ...
                field("Autoinvoice Nos."; Rec."Autoinvoice Nos.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number series used to generate autoinvoices for purchases.';
                }
                field("Autocredit Memo Nos."; Rec."Autocredit Memo Nos.")
                {
                    ApplicationArea = Basic, Suite;
