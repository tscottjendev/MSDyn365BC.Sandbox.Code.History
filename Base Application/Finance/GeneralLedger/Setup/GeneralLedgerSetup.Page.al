    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field(CashVATPrdGrp; Rec."CashVAT Product Posting Group")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'CashVAT Product Posting Group';
                    ToolTip = 'Specifies the VAT product posting group that will be used for the cash account in your company.';
                }
                field("Validate loc.VAT Reg. No."; Rec."Validate loc.VAT Reg. No.")
                {
                    ApplicationArea = Basic, Suite;
                ...
                field("Company Officials Nos."; Rec."Company Officials Nos.")
                {
                    ApplicationArea = Basic, Suite;
            ...
            group("Fiscal Reporting")
            {
                ...
                field("VAT Rounding Type2"; Rec."VAT Rounding Type")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies how the program will round VAT when calculated for the local currency.';
                }
                field("Settlement Round. Factor"; Rec."Settlement Round. Factor")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the rounding factor that will be used for the settlement amounts.';
                }
                field("Minimum VAT Payable"; Rec."Minimum VAT Payable")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the minimum amount allowed for a VAT payable.';
                }
                field("Last Settlement Date"; Rec."Last Settlement Date")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the date that the transaction was last settled.';
                }
                field("Last Gen. Jour. Printing Date"; Rec."Last Gen. Jour. Printing Date")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the date that the general journal was last printed.';
                }
                field("Last General Journal No."; Rec."Last General Journal No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the last used general journal number.';
                }
                field("Last Printed G/L Book Page"; Rec."Last Printed G/L Book Page")
                {
                    ApplicationArea = Basic, Suite;
                    Editable = true;
                    ToolTip = 'Specifies the number of the last printed page of the general ledger book.';
                }
                field("Official Debit Amount"; Rec."Official Debit Amount")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies official debit amount in current fiscal year.';
                }
                field("Official Credit Amount"; Rec."Official Credit Amount")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies official credit amount in current fiscal year.';
                }
                field("VAT Settlement Period"; Rec."VAT Settlement Period")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the type of period used for VAT settlement.';
                }
            }
    ...
    actions
    {
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("Change Reprinting Information for G/L Books")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Change Reprinting Information for G/L Books';
                    Image = ReverseRegister;
                    RunObject = Page "G/L Book Reprinting Info.";
                    ToolTip = 'View or change the page numbering for reprinting the general ledger book report.';
                }
            }
        }
        area(navigation)
