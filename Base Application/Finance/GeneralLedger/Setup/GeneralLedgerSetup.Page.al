    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Simplified Intrastat Decl."; Rec."Simplified Intrastat Decl.")
                {
                    ApplicationArea = BasicEU;
                    ToolTip = 'Specifies whether to use the simplified declaration for Intrastat reporting.';
                }
                field("Currency Euro"; Rec."Currency Euro")
                {
                    ApplicationArea = BasicEU;
                    ToolTip = 'Specifies the local currency that is used to represent the euro currency standard.';
                }
            ...
            group(Reporting)
            {
                ...
                {
                    ApplicationArea = VAT;
                    ToolTip = 'Specifies that you can select the name of the VAT statement template you want to use for printing VAT declarations.';
                }
            ...
            group(Application)
            {
                ...
                field("Use Workdate for Appl./Unappl."; Rec."Use Workdate for Appl./Unappl.")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Use Workdate for Appl./Unappl.';
                    ToolTip = 'Specifies that the work date will be used as the posting date, when you apply/unapply customer or vendor ledger entries.';
                }
            }
