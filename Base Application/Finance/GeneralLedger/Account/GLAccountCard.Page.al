    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies that detailed information of the selected G/L account in the Detail Trial Balance report will be printed, if there is a check mark.';
                }
            ...
            group(Posting)
            {
                ...
                {
                    ApplicationArea = VAT;
                    ToolTip = 'Specifies the percentage of VAT that cannot be deducted for this G/L account.';
                }
