...
page 16 "Chart of Accounts"
{
    ...
    actions
    {
        ...
        area(reporting)
        {
            ...
            {
                ApplicationArea = Basic, Suite;
                Caption = 'G/L Acc. Sheet with Bal. Acc. Info';
                Image = "Report";
                RunObject = Report "SR G/L Acc Sheet Bal Account";
                ToolTip = 'View the G/L account sheet including the selected information.';
            }
            action("G/L Acc. Sheet with Foreign Currency")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'G/L Acc. Sheet with Foreign Currency';
                Image = "Report";
                //The property 'PromotedCategory' can only be set if the property 'Promoted' is set to 'true'
                //PromotedCategory = "Report";
            ...
            action("G/L Acc. Sheet with Reporting Currency")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'G/L Acc. Sheet with Reporting Currency';
                Image = "Report";
                //The property 'PromotedCategory' can only be set if the property 'Promoted' is set to 'true'
                //PromotedCategory = "Report";
            ...
            action("G/L Acc. Sheet with Posting Info")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'G/L Acc. Sheet with Posting Info';
                Image = "Report";
                //The property 'PromotedCategory' can only be set if the property 'Promoted' is set to 'true'
                //PromotedCategory = "Report";
            ...
            action("G/L Acc. Sheet with VAT Info")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'G/L Acc. Sheet with VAT Info';
                Image = "Report";
                //The property 'PromotedCategory' can only be set if the property 'Promoted' is set to 'true'
                //PromotedCategory = "Report";
            ...
            action("Provisional Trial Balance")
            {
                ...
                ToolTip = 'View the trial balance with the influence of unposted journal entries, so that you can see how these entries would change, such as the income statement. Up to three journals can be included in the report.';
            }
            action("G/L Entries with Foreign Currency")
            {
                ApplicationArea = Basic, Suite;
                ...
                ToolTip = 'View the general ledger entries for foreign currencies. All ledger entries can be sorted by number and output for archiving and revision purposes.';
            }
        }
        area(Promoted)
        {
            ...
            group(Category_Report)
            {
                ...
                actionref("G/L Acc. Sheet with Bal. Acc. Info_Promoted"; "G/L Acc. Sheet with Bal. Acc. Info")
                {
                }
