            ...
            group("&E-Payment")
            {
                ...
                group("&LSV")
                {
                    ...
                    action("&LSV Journal")
                    {
                        ...
                        ToolTip = 'Prepare to post payments from LSV customers. ';
                    }
                    action("&Get from LSV Journal")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = '&Get from LSV Journal';
                        ToolTip = 'Insert payment from Slav customers. ';
                    ...
                    action("Read &Debit Direct File")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Read &Debit Direct File';
                        ToolTip = 'View the customer''s'' Direct Debit agreement.';

                        trigger OnAction()
                        begin
                            Clear(LsvMgt);
                            LsvMgt.ImportDebitDirectFile(Rec);
                        end;
                    }
                }
                group("&ESR")
                {
                    Caption = '&ESR';
                    Image = PrintForm;
                    action("Read ESR File")
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Read ESR File';
                        Image = Import;
                        ToolTip = 'View the customer''s ESR agreement.';
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Print ESR Journal';
                        ToolTip = 'View the ESR payments that were imported and checked with the ESR journal. After the ESR file is read, this journal can be output in the cash receipt journal.';
        ...
        area(Promoted)
        {
            group(Category_Process)
            {
                ...
                group(Category_Category6)
                {
                    ...
                    actionref("Print ESR Journal_Promoted"; "Print ESR Journal")
                    {
                    }
                }
                ...
                actionref("Read ESR File_Promoted"; "Read ESR File")
                {
                }
            }
