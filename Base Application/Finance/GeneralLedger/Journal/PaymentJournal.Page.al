    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the code for the special transfer payment type, to be used for the entry on the payment journal line.';
                }
                field("Statistical Code"; Rec."Statistical Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the statistical codes for the entry on the payment journal line.';
                }
            ...
            group("&Payments")
            {
                ...
                group("Electronic Payments")
                {
                    ...
                    action(Void)
                    {
                        ...
                        var
                            GenJournalLine: Record "Gen. Journal Line";
                            VoidElecPayments: Report "Void Electronic Payments";
                        begin
                            GenJournalLine.Reset();
                            GenJournalLine := Rec;
                            GenJournalLine.SetRange("Journal Template Name", Rec."Journal Template Name");
                            ...
                            VoidElecPayments.SetTableView(GenJournalLine);
