    ...
    layout
    {
        area(content)
        {
            ...
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the bank account number for the electronic funds transfer (EFT) journal line.';
                }
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the exchange rate for the vendor in your additional reporting currency.';
                }
                ...
                field("Customer/Vendor Bank"; Rec."Customer/Vendor Bank")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the customer or vendor bank for the electronic funds transfer (EFT) journal line.';
                    Visible = false;
                }
                field("Bank Branch No."; Rec."Bank Branch No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the Customer BSB or Bank Branch Number.';
                    Visible = false;
                }
                field("Bank Account No."; Rec."Bank Account No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the Customer Bank Account Number.';
                    Visible = false;
                }
                ...
                field("EFT Register No."; Rec."EFT Register No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the number of the EFT register.';
                }
            ...
            group("&Payments")
            {
                ...
                action(PrintRemittanceAdvance)
                {
                    ...
                    begin
                        ...
                        OnPrintRemittanceAdvanceOnAfterSetFilters(GenJournalLine, ReportSelections);
                        ReportSelections.SetRange(Usage, ReportSelections.Usage::"V.Remittance");
                        if not ReportSelections.IsEmpty() then
                            ReportSelections.PrintReport(ReportSelections.Usage::"V.Remittance", GenJournalLine)
                        else
                            Report.Run(Report::"Remittance Advice - Journal", true, false, GenJournalLine);
                    end;
                }
                group("EFT Payments")
                {
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Create EFT Payments File';
                        Ellipsis = true;
                        Image = CreateDocument;
                        ToolTip = 'Start the process of generating the EFT Payment file.';
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Cancel EFT Payments Export';
                        Image = Cancel;
                        ...
                        begin
                            Rec.TestField("EFT Register No.");
                            EFTRegister.Get(Rec."EFT Register No.");
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(CancelPostDatedCheck)
                {
                    ...
                    ToolTip = 'Cancel a post-dated check.';
