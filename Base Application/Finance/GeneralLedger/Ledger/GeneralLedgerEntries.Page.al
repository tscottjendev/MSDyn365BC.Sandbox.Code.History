...
page 20 "General Ledger Entries"
{
    ...
    actions
    {
        ...
        area(processing)
        {
            ...
            action(SetPeriodTransNos)
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Set Period Transaction No.';
                Image = NumberSetup;
                RunObject = Report "Set Period Trans. Nos.";
                ToolTip = 'Calculate and assign period transaction numbers to G/L entries for the specified period.';
            }
        }
        area(Promoted)
        {
