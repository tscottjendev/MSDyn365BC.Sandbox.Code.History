...
table 17 "G/L Entry"
{
    ...
    keys
    {
        ...
        key(Key13; "Source Code", "Posting Date", "Document No.")
        {
        }
        key(Key14; "Source Code", "Document No.", "Posting Date")
        {
        }
        key(Key15; "G/L Account No.", "Posting Date", "Source Code")
        {
        }
        key(Key16; "G/L Account No.", "Document No.", "Posting Date")
        {
        }
        key(Key17; "G/L Account No.", "Source Type", "Source No.")
        {
        }
        key(Key18; "G/L Account No.", Letter)
        {
        }
        key(Key19; "Posting Date")
        {
        }
        key(Key20; "Document Type", "Document No.")
        {
        }
        key(Key21; "Dimension Set ID")
        {
        }
    }
