...
table 17 "G/L Entry"
{
    ...
    keys
    {
        ...
        key(Key13; "G/L Account No.", "Posting Date", "VAT Bus. Posting Group", "VAT Prod. Posting Group")
        {
            SumIndexFields = "VAT Amount", Amount;
        }
        key(Key14; "BAS Doc. No.", "BAS Version")
        {
        }
        key(Key15; "G/L Account No.", "BAS Adjustment", "VAT Bus. Posting Group", "VAT Prod. Posting Group", "Posting Date", "BAS Doc. No.")
        {
            SumIndexFields = "VAT Amount", Amount;
        }
        key(Key16; "Source Code", "Posting Date", "Document No.")
        {
        }
