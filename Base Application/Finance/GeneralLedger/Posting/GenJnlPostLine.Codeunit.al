...
codeunit 12 "Gen. Jnl.-Post Line"
{
    ...
    begin
        ...
        if AddCurrencyCode <> '' then
            if AddCurrencyCode <> SrcCurrCode then begin
                ...
                GenJnlLine."Non Ded. Source Curr. VAT Amt." := ExchangeAmtLCYToFCY2(GenJnlLine."Non Ded. VAT Amount");
        ...
        if GenJnlLine."Gen. Posting Type" <> GenJnlLine."Gen. Posting Type"::" " then begin
            ...
            if AddCurrencyCode = '' then begin
                ...
                GenJnlLine."Non Ded. Source Curr. VAT Amt." := 0;
            ...
            VATEntry."Non Ded. VAT Amount" := GenJnlLine."Non Ded. VAT Amount";
            VATEntry."Non Ded. Source Curr. VAT Amt." := GenJnlLine."Non Ded. Source Curr. VAT Amt.";
    ...
    begin
        ...
        if GLEntryVATAmountNotEmpty or (GenJnlLine."Non Ded. VAT Amount" <> 0) or
    ...
    begin
        ...
        if not IsHandled then begin
            ...
            if GenJournalLine."Amount (LCY)" <> 0 then
                if GenJournalLine."System-Created Entry" then begin
                    CVLedgEntryBuf."Original Pmt. Disc. Possible" := Round(GenJournalLine."Orig. Pmt. Disc. Possible", AmountRoundingPrecision);
                    CVLedgEntryBuf."Orig. Pmt. Disc. Possible(LCY)" := Round(GenJournalLine."Orig. Pmt. Disc. Possible(LCY)");
    ...
    local procedure CheckAccountNo(GenJournalLine: Record "Gen. Journal Line")
    var
    ...
    begin
        ...
        if GenJournalTemplate.Type = GenJournalTemplate.Type::Financial then
