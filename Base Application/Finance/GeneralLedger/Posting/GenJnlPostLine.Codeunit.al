...
codeunit 12 "Gen. Jnl.-Post Line"
{
    ...
    var
        ...
        EntryProfitLcy: Decimal;
        EntrySalesPurchLCY: Decimal;
        Iterations: Integer;
        NextCustVendEntry: Integer;
        NoOfPayments: Integer;
        RemainingAmount: Decimal;
        RemainingAmountLCY: Decimal;
        RemainingProfitLCY: Decimal;
        RemainingSalesPurchLCY: Decimal;
        TotalAmount2: Decimal;
        TotalAmountLCY: Decimal;
        TotalProfitLCY: Decimal;
        TotalSalesPurchLCY: Decimal;
        CheckDim: Boolean;
    ...
    begin
        ...
        if CheckLine then begin
            ...
            if GenJnlCheckLine.DateNotAllowed(GenJournalLine."Posting Date") then
                GenJournalLine.FieldError("Posting Date", Text1130024);
    end;
    ...
    begin
        ...
        if GenJnlLine."Gen. Posting Type" <> GenJnlLine."Gen. Posting Type"::" " then begin
            ...
            if not IsHandled then begin
                if GenJnlLine."Document Type" <> GenJnlLine."Document Type"::"Finance Charge Memo" then
                    if ((VATPostingSetup."Allow Posting From" <> 0D) and
                        (VATPostingSetup."Allow Posting From" > GenJnlLine."Operation Occurred Date")) or
                       ((VATPostingSetup."Allow Posting To" <> 0D) and
                        (VATPostingSetup."Allow Posting To" < GenJnlLine."Operation Occurred Date"))
                    then
                        Error(Text1130022);
                GenJnlLine.TestField(GenJnlLine."VAT Calculation Type", VATPostingSetup."VAT Calculation Type");
            end;
    ...
    var
        ...
        NondeducVATAmount: Decimal;
        NondeducBaseAmount: Decimal;
        SrcCurrNondeducVATAmount: Decimal;
        SrcCurrNondeducBaseAmount: Decimal;
        IsHandled: Boolean;
    begin
        IsHandled := false;
        OnBeforeInsertVAT(
        ...
        if GenJnlLine."Bill-to/Pay-to No." <> '' then
            case VATEntry.Type of
                VATEntry.Type::Purchase:
                    begin
                        if Vend."No." <> GenJnlLine."Bill-to/Pay-to No." then
                            Vend.Get(GenJnlLine."Bill-to/Pay-to No.");
                        VATEntry."Fiscal Code" := Vend."Fiscal Code";
                    end;
                VATEntry.Type::Sale:
                    begin
                        if Cust."No." <> GenJnlLine."Bill-to/Pay-to No." then
                            Cust.Get(GenJnlLine."Bill-to/Pay-to No.");
        ...
        VATEntry."VAT Identifier" := GenJnlLine."VAT Identifier";
        VATEntry."Include in VAT Transac. Rep." := GenJnlLine."Include in VAT Transac. Rep.";
        VATEntry."Refers To Period" := GenJnlLine."Refers to Period";
        VATEntry."Individual Person" := GenJnlLine."Individual Person";
        VATEntry.Resident := GenJnlLine.Resident;
        VATEntry."First Name" := GenJnlLine."First Name";
        VATEntry."Last Name" := GenJnlLine."Last Name";
        VATEntry."Date of Birth" := GenJnlLine."Date of Birth";
        VATEntry."Place of Birth" := GenJnlLine."Place of Birth";
        VATEntry."Tax Representative Type" := GenJnlLine."Tax Representative Type";
        VATEntry."Tax Representative No." := GenJnlLine."Tax Representative No.";
        if (Cust."Fiscal Code" = '') or (Vend."Fiscal Code" = '') then
            VATEntry."Fiscal Code" := GenJnlLine."Fiscal Code";
        if (Cust."VAT Registration No." = '') or (Vend."VAT Registration No." = '') then
            VATEntry."VAT Registration No." := GenJnlLine."VAT Registration No.";
        VATEntry."Contract No." := GenJnlLine."Contract No.";
        if VATEntry.Type <> VATEntry.Type::" " then
            if VATPostingSetup."EU Service" and (VATEntry.Type <> VATEntry.Type::Settlement) then begin
                if VATPostingSetup."Service Tariff No. Mandatory" then
                    GenJnlLine.TestField(GenJnlLine."Service Tariff No.");
                VATEntry."Service Tariff No." := GenJnlLine."Service Tariff No.";
                VATEntry."Transport Method" := GenJnlLine."Transport Method";
                VATEntry."Payment Method" := GenJnlLine."Payment Method Code";
            end else
                GenJnlLine.TestField(GenJnlLine."Service Tariff No.", '');
        if GenJnlLine."Fattura Document Type" = '' then
            VATEntry."Fattura Document Type" := VATPostingSetup."Fattura Document Type"
        else
            VATEntry."Fattura Document Type" := GenJnlLine."Fattura Document Type";
        ...
        if GenJnlLine."Gen. Posting Type" <> GenJnlLine."Gen. Posting Type"::" " then begin
                ...
                GenJnlLine."VAT Posting"::"Automatic VAT Entry":
                    begin
                        ...
                        ChangeVATAmounts(
                          ...
                          GenJnlLine."Deductible %", GLSetup."Amount Rounding Precision", NDVATAmountRounding, NDVATBaseRounding);
                        ChangeVATAmounts(
                          SrcCurrVATAmount, SrcCurrVATBase, SrcCurrNondeducVATAmount, SrcCurrNondeducBaseAmount,
                          GenJnlLine."Deductible %", AddCurrency."Amount Rounding Precision", SrcCurrNDVATAmountRounding, SrcCurrNDVATBaseRounding);
                    end;
                GenJnlLine."VAT Posting"::"Manual VAT Entry":
                    begin
                        if GenJnlLine."Gen. Posting Type" = GenJnlLine."Gen. Posting Type"::Settlement then begin
            ...
            VATEntry."Nondeductible Amount" := NondeducVATAmount;
            VATEntry."Nondeductible Base" := NondeducBaseAmount;
            VATEntry."Add. Curr. Nondeductible Amt." := SrcCurrNondeducVATAmount;
            VATEntry."Add. Curr. Nondeductible Base" := SrcCurrNondeducBaseAmount;
            ...
            if not ((GenJnlLine."Document Type" = GenJnlLine."Document Type"::Reminder) or IsReminderFinChargeMemoCanceling(GenJnlLine)) then begin
                GeneralLedgerSetup.GetRecordOnce();
                if GeneralLedgerSetup."Use Activity Code" then
                    GenJnlLine.TestField(GenJnlLine."Activity Code");
            end;
            VATEntry."Activity Code" := GenJnlLine."Activity Code";
            ...
            then begin
                if UnrealizedVAT then
                    Error(
                      Text1130021,
                      VATPostingSetup.FieldCaption("VAT Calculation Type"), VATPostingSetup."VAT Calculation Type",
                      VATEntry.FieldCaption(Type), VATEntry.Type);
                VATEntry2 := VATEntry;
                VATEntry."Entry No." := NextVATEntryNo;
                ...
                VATEntry."Add. Curr. Nondeductible Amt." := 0;
                if GenJnlLine."VAT Calculation Type" = GenJnlLine."VAT Calculation Type"::"Reverse Charge VAT" then
                    if (GenJnlLine."Document Type" = GenJnlLine."Document Type"::Invoice) and (GenJnlLine."Reverse Sales VAT No." = '') then
                        if GenJnlLine."Reverse Sales VAT No. Series" <> '' then begin
                            NoSeriesRec.Get(GenJnlLine."Reverse Sales VAT No. Series");
                            NoSeriesRec.TestField("Date Order");
                            GenJnlLine."Reverse Sales VAT No." := NoSeries.GetNextNo(GenJnlLine."Reverse Sales VAT No. Series", GenJnlLine."Posting Date");
                        end;
        ...
        if NonDeductibleVAT.IsNonDeductibleVATEnabled() then
            ...
            VATPostingParameters.InsertRecord(
                GenJnlLine, VATPostingSetup, GLEntryVATAmount, SrcCurrGLEntryVATAmt, SrcCurrCode, UnrealizedVAT, VATAmount, SrcCurrVATAmount, NondeducVATAmount, SrcCurrNondeducVATAmount);
        InsertVATForGLEntry(
                ...
                GenJnlLine."Gen. Posting Type"::Purchase:
                    case VATPostingSetup."VAT Calculation Type" of
                        ...
                        VATPostingSetup."VAT Calculation Type"::"Sales Tax":
                            begin
                                if GenJnlLine."Deductible %" <> 100 then
                                    Error(Text1130018);
    ...
    begin
        ...
        if not IsHandled then begin
            ...
            InitPaymentTerms(GenJournalLine);

            Iterations := 0;
            TotalAmount2 := GenJournalLine.Amount;
            RemainingAmount := TotalAmount2;
            TotalAmountLCY := GenJournalLine."Amount (LCY)";
            RemainingAmountLCY := TotalAmountLCY;
            TotalSalesPurchLCY := GenJournalLine."Sales/Purch. (LCY)";
            RemainingSalesPurchLCY := TotalSalesPurchLCY;
            TotalProfitLCY := GenJournalLine."Profit (LCY)";
            RemainingProfitLCY := TotalProfitLCY;

            OnPostCustOnBeforeLoopPaymentTermsLine(GenJournalLine, PaymentTermsLine, TotalAmountLCY, TotalAmount2, RemainingAmountLCY, TotalSalesPurchLCY, RemainingSalesPurchLCY, TotalProfitLCY, RemainingProfitLCY);
            ...
            repeat
                ...
                CustLedgEntry."Applies-to Occurrence No." := GenJournalLine."Applies-to Occurrence No.";
                CustLedgEntry."Due Date" := PaymentTermsLine."Due Date";
                CustLedgEntry."Pmt. Discount Date" := PaymentTermsLine."Pmt. Discount Date";
                CustLedgEntry."Cumulative Bank Receipts" := GenJournalLine."Cumulative Bank Receipts";
                CustLedgEntry."Document Type to Close" := GenJournalLine."Document Type to Close";
                CustLedgEntry."Document No. to Close" := GenJournalLine."Document No. to Close";
                CustLedgEntry."Document Occurrence to Close" := GenJournalLine."Document Occurrence to Close";
                ...
                CustLedgEntry."Bank Receipt" := GenJournalLine."Bank Receipt";
                CustLedgEntry."Cumulative Bank Receipts" := GenJournalLine."Cumulative Bank Receipts";
                CustLedgEntry."Allow Issue" := GenJournalLine."Allow Issue";
                ...
                OnPostCustOnBeforeTempDtldCVLedgEntryBufInit(GenJournalLine, CustLedgEntry, PaymentTermsLine, TotalAmount2, TotalAmountLCY, EntryAmount, EntryAmountLCY, Iterations, NoOfPayments, AmountRoundingPrecision);
                ...
                if EntryAmountLCY <> 0 then begin
                    if GLSetup."Pmt. Disc. Excl. VAT" then begin
                        if EntrySalesPurchLCY = 0 then
                            ...
                            (EntryAmountLCY + TotalVATAmountOnJnlLines(GenJournalLine)) * EntryAmount / EntryAmountLCY
                        else
    ...
    begin
        ...
        OnPostVendOnBeforeLoopPaymentTermsLine(GenJournalLine, PaymentTermsLine, TotalAmountLCY, TotalAmount2, RemainingAmountLCY, TotalSalesPurchLCY, RemainingSalesPurchLCY, TotalProfitLCY, RemainingProfitLCY);
        ...
        repeat
            ...
            VendLedgEntry."Entry No." := NextCustVendEntry;
            ...
            VendLedgEntry."Purchase (LCY)" := EntrySalesPurchLCY;
            ...
            OnPostVendOnBeforeTempDtldCVLedgEntryBufInit(GenJournalLine, VendLedgEntry, PaymentTermsLine, TotalAmount2, TotalAmountLCY, EntryAmount, EntryAmountLCY, Iterations, NoOfPayments, AmountRoundingPrecision);
    ...
    begin
        ...
        if not NewCVLedgEntryBuf.Open and not AllApplied then begin
            ...
            if NewCVLedgEntryBuf."Document Type" = NewCVLedgEntryBuf."Document Type"::Dishonored then begin
                NewCVLedgEntryBuf."Document Type to Close" := OldCVLedgEntryBuf."Document Type to Close";
                NewCVLedgEntryBuf."Document No. to Close" := OldCVLedgEntryBuf."Document No. to Close";
                NewCVLedgEntryBuf."Document Occurrence to Close" := OldCVLedgEntryBuf."Document Occurrence to Close";
            end;
        end;
    ...
    begin
        ...
        repeat
            ...
            case OldCustLedgEntry."Document Type" of
                OldCustLedgEntry."Document Type"::Dishonored:
                    begin
                        OldCustLedgEntry."Document Type to Close" := GenJnlLine."Document Type to Close";
                        OldCustLedgEntry."Document No. to Close" := GenJnlLine."Document No. to Close";
                    end;
                OldCustLedgEntry."Document Type"::Payment:
                    begin
                        NewCVLedgEntryBuf."Document Type to Close" := OldCustLedgEntry."Document Type to Close";
                        NewCVLedgEntryBuf."Document No. to Close" := OldCustLedgEntry."Document No. to Close";
                    end;
            end;
            ...
            Completed := FindNextOldCustLedgEntryToApply(GenJnlLine, TempOldCustLedgEntry, NewCVLedgEntryBuf, PaymentTerms);
        until Completed;
    ...
    local procedure FindNextOldCustLedgEntryToApply(GenJnlLine: Record "Gen. Journal Line"; var TempOldCustLedgEntry: Record "Cust. Ledger Entry" temporary; NewCVLedgEntryBuf: Record "CV Ledger Entry Buffer"; PaymentTerms: Record "Payment Terms") Completed: Boolean
    var
        IsHandled: Boolean;
    begin
    ...
    begin
        ...
        if GenJnlLine."Applies-to Doc. No." <> '' then begin
            ...
            OldCustLedgEntry.SetLoadFields(Positive, "Posting Date", "Currency Code", "Bank Receipt Issued");
            OldCustLedgEntry.SetCurrentKey("Document Type", "Document No.", "Document Occurrence", "Customer No.");
            ...
            if GenJnlLine."Document No. to Close" <> '' then begin
                OldCustLedgEntry.SetRange("Document Type to Close", GenJnlLine."Document Type to Close");
                OldCustLedgEntry.SetRange("Document No. to Close", GenJnlLine."Document No. to Close");
                OldCustLedgEntry.SetRange("Document Occurrence to Close", GenJnlLine."Document Occurrence to Close");
            end;
    ...
    begin
        ...
        repeat
            ...
            Completed := FindNextOldVendLedgEntryToApply(GenJnlLine, TempOldVendLedgEntry, NewCVLedgEntryBuf, PaymentTerms);
        until Completed;
    ...
    local procedure FindNextOldVendLedgEntryToApply(GenJnlLine: Record "Gen. Journal Line"; var TempOldVendLedgEntry: Record "Vendor Ledger Entry" temporary; NewCVLedgEntryBuf: Record "CV Ledger Entry Buffer"; PaymentTerms: Record "Payment Terms") Completed: Boolean
    var
        IsHandled: Boolean;
    begin
    ...
    begin
        ...
        VATEntry."Operation Occurred Date" := GenJnlLine."Posting Date";
        VATEntry."VAT Identifier" := VATEntry2."VAT Identifier";
    ...
    begin
        ...
        repeat
            ...
            if not IsHandled then begin
                ...
                UpdateCustLedgEntry(DetailedCustLedgEntry2, UnAppliedBill);
    ...
    local procedure UpdateCustLedgEntry(DtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry"; var UnAppliedBill: Boolean)
    var
        CustLedgEntry: Record "Cust. Ledger Entry";
    begin
        ...
        if CustLedgEntry."Document Type" = CustLedgEntry."Document Type"::Dishonored then begin
            CustLedgEntry."Document Type to Close" := CustLedgEntry."Document Type to Close"::" ";
            CustLedgEntry."Document No. to Close" := '';
        end;
    ...
    local procedure GetNonDeductibleVATAccountNo(PostingGLAccountNo: Code[20]; VATPostingSetup: Record "VAT Posting Setup"): Code[20]
    begin
    ...
    begin
        IsHandled := false;
        OnBeforeInitPaymentTerms(PaymentTermsLine, GenJnlLine, NoOfPayments, IsHandled);
        if IsHandled then
            exit;

        PaymentTermsLine.Reset();
        PaymentTermsLine.SetRange("Sales/Purchase", PaymentTermsLine."Sales/Purchase"::" ");
        PaymentTermsLine.SetRange(Type, PaymentTermsLine.Type::"General Journal");
        PaymentTermsLine.SetRange(Code, GenJnlLine."Journal Batch Name");
        PaymentTermsLine.SetRange("Journal Template Name", GenJnlLine."Journal Template Name");
        PaymentTermsLine.SetRange("Journal Line No.", GenJnlLine."Line No.");
        if PaymentTermsLine.Find('-') then begin
            NoOfPayments := 0;
            repeat
                NoOfPayments := NoOfPayments + 1;
                if PaymentTermsLine."Due Date" = 0D then
                    Error(Text1130001,
                      PaymentTermsLine.FieldCaption("Due Date"),
                      PaymentTermsLine.TableCaption(),
                      PaymentTermsLine."Line No.");
            until PaymentTermsLine.Next() = 0;
            PaymentTermsLine.Find('-');
        end else begin
            NoOfPayments := 1;
            PaymentTermsLine.Init();
            PaymentTermsLine."Sales/Purchase" := 0;
            PaymentTermsLine.Type := PaymentTermsLine.Type::"General Journal";
            PaymentTermsLine.Code := GenJnlLine."Journal Batch Name";
            PaymentTermsLine."Journal Template Name" := GenJnlLine."Journal Template Name";
            PaymentTermsLine."Journal Line No." := GenJnlLine."Line No.";
            PaymentTermsLine."Line No." := 10000;
            PaymentTermsLine."Payment %" := 100;
            PaymentTermsLine."Due Date" := GenJnlLine."Due Date";
        end;
    end;
    ...
    begin
        ...
        VATBookEntry.SetCurrentKey(
          ...
          "VAT %", "Deductible %", "VAT Identifier", "Transaction No.");
        VATBookEntry.SetRange("Document No.", NewVATEntry."Document No.");
        VATBookEntry.SetRange(Type, NewVATEntry.Type);
        VATBookEntry.SetRange("VAT Bus. Posting Group", NewVATEntry."VAT Bus. Posting Group");
        VATBookEntry.SetRange("VAT Prod. Posting Group", NewVATEntry."VAT Prod. Posting Group");
        VATBookEntry.SetRange("VAT %", NewVATEntry."VAT %");
        VATBookEntry.SetRange("Deductible %", NewVATEntry."Deductible %");
        ...
        OnInsertVATBookEntryOnAfterSetFilters(VATBookEntry, NewVATEntry);
        if not VATBookEntry.FindFirst() then begin
            VATBookEntry.Init();
            VATBookEntry."Entry No." := NewVATEntry."Entry No.";

            VATBookEntry."Posting Date" := NewVATEntry."Posting Date";
            VATBookEntry."Operation Occurred Date" := NewVATEntry."Operation Occurred Date";
            VATBookEntry."Document No." := NewVATEntry."Document No.";
            VATBookEntry.Type := NewVATEntry.Type;
            VATBookEntry."VAT Bus. Posting Group" := NewVATEntry."VAT Bus. Posting Group";
            VATBookEntry."VAT Prod. Posting Group" := NewVATEntry."VAT Prod. Posting Group";
            VATBookEntry."VAT %" := NewVATEntry."VAT %";
            VATBookEntry."Deductible %" := NewVATEntry."Deductible %";
            VATBookEntry."VAT Identifier" := NewVATEntry."VAT Identifier";
            VATBookEntry."Transaction No." := NewVATEntry."Transaction No.";
            if NewVATEntry."Tax Liable" = true then begin
                NewVATEntry."Tax Liable" := false;
                VATBookEntry."Reverse VAT Entry" := true;
            end;

            if NewVATEntry."Posting Date" < FiscalYearStartDate then
                VATBookEntry."Official Date" := NormalDate(WorkDate())
            else
                VATBookEntry."Official Date" := NormalDate(NewVATEntry."Posting Date");

            if NewVATEntry."Unrealized VAT Entry No." <> 0 then begin
                VATBookEntry."Unrealized VAT" := true;
                VATBookEntry."Unrealized VAT Entry No." := NewVATEntry."Unrealized VAT Entry No.";
            end;
            VATBookEntry.Insert();
            OnAfterInsertVATBookEntry(VATBookEntry, VATEntry);
        end;
    end;

    [Scope('OnPrem')]
    procedure InsertGLBookEntry(NewGLEntry: Record "G/L Entry")
    var
        IsHandled: Boolean;
    begin
        IsHandled := false;
        OnBeforeInsertGLBookEntry(NewGLEntry, IsHandled);
        if IsHandled then
            exit;

        GLBookEntry.Reset();
        GLBookEntry.SetCurrentKey("Transaction No.", "G/L Account No.", "Document No.", Positive, "Source Type", "Source No.");
        ...
        if not GLBookEntry.FindFirst() then begin
            ...
            GLBookEntry."G/L Account No." := NewGLEntry."G/L Account No.";
            GLBookEntry."Posting Date" := NewGLEntry."Posting Date";
            GLBookEntry."Document No." := NewGLEntry."Document No.";
            GLBookEntry."Document Date" := NewGLEntry."Document Date";
            GLBookEntry."Document Type" := NewGLEntry."Document Type";
            GLBookEntry."External Document No." := NewGLEntry."External Document No.";
            GLBookEntry."Source Type" := NewGLEntry."Source Type";
            GLBookEntry."Source No." := NewGLEntry."Source No.";
            GLBookEntry.Positive := NewGLEntry.Positive;
            GLBookEntry."Transaction No." := NewGLEntry."Transaction No.";
            GLBookEntry."Official Date" := NewGLEntry."Official Date";
            GLBookEntry.Insert();
        end;

        OnAfterInsertGLBookEntry(NewGLEntry);
    end;
    ...
    local procedure SetRelatedEntryData(GenJnlLine: Record "Gen. Journal Line")
    var
    ...
    begin
        if VATEntry.Type <> VATEntry.Type::Settlement then begin
            ...
            if GenJnlLine."Related Entry No." <> 0 then begin
                if not (GenJnlLine."Document Type" in [GenJnlLine."Document Type"::Invoice, GenJnlLine."Document Type"::"Credit Memo"]) then
                    GenJnlLine.FieldError(GenJnlLine."Document Type");
                Vend.Get(VATEntry."Bill-to/Pay-to No.");
                if Vend.IsCustomAuthorityVendor() then
                    VATEntry.Validate("Related Entry No.", GenJnlLine."Related Entry No.")
                else begin
                    // case when user linked foreign goods invoice to previosly posted customs authority
                    RelatedVendorLedgerEntry.Get(GenJnlLine."Related Entry No.");
                    VATEntry2.SetCurrentKey("Posting Date", Type, "Document Type", "Document No.");
                    VATEntry2.SetRange("Posting Date", RelatedVendorLedgerEntry."Posting Date");
                    VATEntry2.SetRange(Type, VATEntry2.Type::Purchase);
                    VATEntry2.SetRange("Document Type", VATEntry2."Document Type"::Invoice);
                    VATEntry2.SetRange("Document No.", RelatedVendorLedgerEntry."Document No.");
                    VATEntry2.ModifyAll("Related Entry No.", NextEntryNo);
                end;
            end;
        end;
    end;
    ...
    var
        ...
        VATPlafond: Record "VAT Plafond Period";
    begin
        if ValidateVATIdentifier and (VATEntry.Type = VATEntry.Type::Purchase) then
            if VATIdentifier.Get(VATEntry."VAT Identifier") then
                VATEntry."Plafond Entry" := VATIdentifier."Subject to VAT Plafond";

        if VATEntry."Plafond Entry" then
            VATPlafond.CheckAmount(VATEntry."Operation Occurred Date", VATEntry.Base);
    end;
    ...
    procedure UnapplyBill(var NewCustLedgEntry: Record "Cust. Ledger Entry")
    var
        OldCustLedgEntry: Record "Cust. Ledger Entry";
    begin
        if NewCustLedgEntry."Document Type" = NewCustLedgEntry."Document Type"::Dishonored then begin
            ...
            if OldCustLedgEntry.FindSet() then
                repeat
                    if OldCustLedgEntry."Bank Receipt Issued" then
                        HandleBill(OldCustLedgEntry, true);
                until OldCustLedgEntry.Next() = 0;
        end else
            if NewCustLedgEntry."Bank Receipt Issued" then
                HandleBill(NewCustLedgEntry, true);
    end;

    procedure HandleBill(var CustLedgEntry: Record "Cust. Ledger Entry"; IsUnApply: Boolean)
    var
        OldCustLedgEntry2: Record "Cust. Ledger Entry";
        IsHandled: Boolean;
    begin
        IsHandled := false;
        OnBeforeHandleBill(CustLedgEntry, IsUnApply, IsHandled);
        if IsHandled then
            exit;

        OldCustLedgEntry2.Reset();
        ...
        if OldCustLedgEntry2.FindFirst() then
            if IsUnApply then begin
                if CustLedgEntry."Bank Receipt Issued" then begin
                    ...
                    UpdateCustLedgEntryBankRcpt(OldCustLedgEntry2, CustLedgEntry);
                    OnHandleBillOnAfterUpdateCustLedgEntryBankRcpt(OldCustLedgEntry2, CustLedgEntry, IsUnApply);
                    OldCustLedgEntry2."Allow Issue" := true;
                    OldCustLedgEntry2.Modify();
                    ClearCustLedgEntryBankRcpt(CustLedgEntry);
                    CustLedgEntry.Modify();
                    UpdDtldCustLedgEntryBankRcpt(OldCustLedgEntry2."Entry No.", true);
                end;
            end else begin
                OnHandleBillOnBeforeUpdateCustLedgEntryBankRcpt(OldCustLedgEntry2, CustLedgEntry, IsUnApply);
                UpdateCustLedgEntryBankRcpt(CustLedgEntry, OldCustLedgEntry2);
                OnHandleBillOnAfterUpdateCustLedgEntryBankRcpt(OldCustLedgEntry2, CustLedgEntry, IsUnApply);
                CustLedgEntry.Modify();
                ClearCustLedgEntryBankRcpt(OldCustLedgEntry2);
                OldCustLedgEntry2."Allow Issue" := false;

                OnHandleBillOnBeforeModifyOldCustLedgEntry(OldCustLedgEntry2, CustLedgEntry, IsUnApply);

                OldCustLedgEntry2.Modify();
                UpdDtldCustLedgEntryBankRcpt(OldCustLedgEntry2."Entry No.", false);
            end;

        OnAfterHandleBill(CustLedgEntry, IsUnApply);
    end;

    local procedure UpdateCustLedgEntryBankRcpt(var CustLedgerEntry: Record "Cust. Ledger Entry"; CustLedgerEntrySource: Record "Cust. Ledger Entry")
    begin
        CustLedgerEntry."Bank Receipt Issued" := CustLedgerEntrySource."Bank Receipt Issued";
        CustLedgerEntry."Bank Receipt Temp. No." := CustLedgerEntrySource."Bank Receipt Temp. No.";
        CustLedgerEntry."Bank Receipts List No." := CustLedgerEntrySource."Bank Receipts List No.";
        CustLedgerEntry."Customer Bill No." := CustLedgerEntrySource."Customer Bill No.";
    end;

    local procedure ClearCustLedgEntryBankRcpt(var CustLedgerEntry: Record "Cust. Ledger Entry")
    begin
        CustLedgerEntry."Bank Receipt Issued" := false;
        CustLedgerEntry."Bank Receipt Temp. No." := '';
        CustLedgerEntry."Bank Receipts List No." := '';
        CustLedgerEntry."Customer Bill No." := '';
    end;

    local procedure UpdDtldCustLedgEntryBankRcpt(EntryNo: Integer; BankReceiptIssued: Boolean)
    var
        DtldCustLedgEntry: Record "Detailed Cust. Ledg. Entry";
    begin
    ...
    var
        ...
        Sign: Decimal;
    begin
        if not HasNonDeductibleVAT then
            exit;
        ...
        InitGLEntry(
          GenJournalLine, GLEntry, GetNonDeductibleVATAccountNo(PostingGLAccountNo, VATPostingSetup),
          -NonDeductibleVATAmount, NonDeductibleVATAmount, true, true);
        GLEntry."Posting Date" := DeferralPostingBuffer."Posting Date";
        GLEntry.Description := DeferralPostingBuffer.Description;
        GLEntry.CopyFromDeferralPostBuffer(DeferralPostingBuffer);
    ...
    local procedure IsReminderFinChargeMemoCanceling(GenJournalLine: Record "Gen. Journal Line"): Boolean
    var
        IssuedReminderHeader: Record "Issued Reminder Header";
        IssuedFinChargeMemoHeader: Record "Issued Fin. Charge Memo Header";
    begin
        IssuedFinChargeMemoHeader.SetRange(Canceled, true);
        IssuedFinChargeMemoHeader.SetRange("Canceled By Document No.", GenJournalLine."Document No.");
        if not IssuedFinChargeMemoHeader.IsEmpty() then
            exit(true);

        IssuedReminderHeader.SetRange(Canceled, true);
        IssuedReminderHeader.SetRange("Canceled By Document No.", GenJournalLine."Document No.");
    ...
    var
        CustLedgerEntry: Record "Cust. Ledger Entry";
    begin
        CustLedgerEntry.SetRange("Document Type", CustLedgerEntry2."Document Type");
        CustLedgerEntry.SetRange("Document No.", CustLedgerEntry2."Document No.");
        CustLedgerEntry.SetRange("Posting Date", CustLedgerEntry2."Posting Date");
        CustLedgerEntry.SetRange("Customer No.", CustLedgerEntry2."Customer No.");
        CustLedgerEntry.FindSet();
        repeat
            CustLedgerEntry.CalcFields("Amount (LCY)", "Remaining Amt. (LCY)", "Original Amt. (LCY)");
            PaidAmount += CustLedgerEntry."Amount (LCY)" - CustLedgerEntry."Remaining Amt. (LCY)";
            TotalOriginalAmtLCY += CustLedgerEntry."Original Amt. (LCY)";
    ...
    var
        VendorLedgerEntry: Record "Vendor Ledger Entry";
    begin
        VendorLedgerEntry.SetRange("Document Type", VendorLedgerEntry2."Document Type");
        VendorLedgerEntry.SetRange("Document No.", VendorLedgerEntry2."Document No.");
        VendorLedgerEntry.SetRange("Posting Date", VendorLedgerEntry2."Posting Date");
        VendorLedgerEntry.SetRange("Vendor No.", VendorLedgerEntry2."Vendor No.");
        VendorLedgerEntry.FindSet();
        repeat
            VendorLedgerEntry.CalcFields("Amount (LCY)", "Remaining Amt. (LCY)", "Original Amt. (LCY)");
            PaidAmount += -VendorLedgerEntry."Amount (LCY)" + VendorLedgerEntry."Remaining Amt. (LCY)";
            TotalOriginalAmtLCY += VendorLedgerEntry."Original Amt. (LCY)";
    ...
    local procedure UpdateDocOccurrenceAppliedAmount(var TempCVLedgerEntryBufferDocOccurrence: Record "CV Ledger Entry Buffer" temporary; AppliedAmount: Decimal; DocumentType: Enum "Gen. Journal Document Type"; DocumentNo: Code[20]; PostingDate: Date; CVNo: Code[20])
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertGLBookEntry(var GLEntry: Record "G/L Entry"; var IsHandled: Boolean);
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInsertGLBookEntry(var GLEntry: Record "G/L Entry");
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeHandleBill(CustLedgEntry: Record "Cust. Ledger Entry"; IsUnApply: Boolean; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnHandleBillOnAfterUpdateCustLedgEntryBankRcpt(var OldCustLedgEntry2: Record "Cust. Ledger Entry"; var CustLedgEntry: Record "Cust. Ledger Entry"; IsUnApply: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterHandleBill(var CustLedgEntry: Record "Cust. Ledger Entry"; IsUnApply: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnInsertVATOnBeforeReverseChargeVATEntryInsert(var VATEntry: Record "VAT Entry"; var GenJnlLine: Record "Gen. Journal Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnPostVendOnBeforeLoopPaymentTermsLine(var GenJournalLine: Record "Gen. Journal Line"; var PaymentLines: Record "Payment Lines"; var TotalAmountLCY: Decimal; var TotalAmount2: Decimal; var RemainingAmountLCY: Decimal; var TotalSalesPurchLCY: Decimal; var RemainingSalesPurchLCY: Decimal; var TotalProfitLCY: Decimal; var RemainingProfitLCY: Decimal)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnPostVendOnBeforeTempDtldCVLedgEntryBufInit(var GenJournalLine: Record "Gen. Journal Line"; var VendorLedgerEntry: Record "Vendor Ledger Entry"; var PaymentLines: Record "Payment Lines"; var TotalAmount2: Decimal; var TotalAmountLCY: Decimal; var EntryAmount: Decimal; var EntryAmountLCY: Decimal; Iterations: Integer; NoOfPayments: Integer; AmountRoundingPrecision: Decimal)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnPostCustOnBeforeTempDtldCVLedgEntryBufInit(var GenJournalLine: Record "Gen. Journal Line"; var CustLedgerEntry: Record "Cust. Ledger Entry"; var PaymentLines: Record "Payment Lines"; var TotalAmount2: Decimal; var TotalAmountLCY: Decimal; var EntryAmount: Decimal; var EntryAmountLCY: Decimal; Iterations: Integer; NoOfPayments: Integer; AmountRoundingPrecision: Decimal)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnPostCustOnBeforeLoopPaymentTermsLine(var GenJournalLine: Record "Gen. Journal Line"; var PaymentLines: Record "Payment Lines"; var TotalAmountLCY: Decimal; var TotalAmount2: Decimal; var RemainingAmountLCY: Decimal; var TotalSalesPurchLCY: Decimal; var RemainingSalesPurchLCY: Decimal; var TotalProfitLCY: Decimal; var RemainingProfitLCY: Decimal)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnHandleBillOnBeforeModifyOldCustLedgEntry(var OldCustLedgerEntry2: Record "Cust. Ledger Entry"; CustLedgerEntry: Record "Cust. Ledger Entry"; IsUnApply: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeApplyBill(var NewCustLedgerEntry: Record "Cust. Ledger Entry"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInitPaymentTerms(var PaymentLines: Record "Payment Lines"; var GenJournalLine: Record "Gen. Journal Line"; var NoOfPayments: Integer; var IsHandled: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnInsertVATBookEntryOnAfterSetFilters(var VATBookEntry: Record "VAT Book Entry"; VATEntry: Record "VAT Entry")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterInsertVATBookEntry(var VATBookEntry: Record "VAT Book Entry"; VATEntry: Record "VAT Entry")
    begin
    end;
