...
codeunit 12 "Gen. Jnl.-Post Line"
{
    ...
    var
        ...
        LastSourceCurrencyVATAmount: Decimal;
    begin
    ...
    local procedure UpdateSourceCurrencyAmounts(var TempGLEntry: Record "G/L Entry" temporary; var LastSourceCurrencyTaxAmount: Decimal)
    begin
        if LastSourceCurrencyTaxAmount <> 0 then begin // VAT case
        ...
        if IsTempGLEntryBufEmpty() then begin
            if GenJournalLineToPost."Financial Void" then
                ...
                if CheckDtldCustLegderEntryCreateBills(DetailedCustLedgEntry) then
                    ...
                    GLAccountNo := CustomerPostingGroup.GetReceivablesAccount();
            InitGLEntry(
              GenJournalLineToPost, GLEntry, GLAccountNo, PositiveLCYAppAmt,
              PositiveACYAppAmt, false, true);
            InsertGLEntry(GenJournalLineToPost, GLEntry, false);
            InitGLEntry(
              GenJournalLineToPost, GLEntry, CustomerPostingGroup."Receivables Account", NegativeLCYAppAmt,
            ...
            if FinancialVoidWithMethodCreateBills(GenJournalLineToPost) then
                ...
                if GenJournalLineToPost."Financial Void" then
                    ...
                    if CheckDtldVendLegderEntryCreateBills(DetailedVendorLedgEntry) then
                        ...
                        GLAccountNo := VendorPostingGroup.GetPayablesAccount();
            InitGLEntry(
              GenJournalLineToPost, GLEntry, VendorPostingGroup.GetPayablesAccount(),
              PositiveLCYAppAmt, PositiveACYAppAmt, false, true);
            InsertGLEntry(GenJournalLineToPost, GLEntry, false);
            InitGLEntry(
              GenJournalLineToPost, GLEntry, GLAccountNo,
    ...
    [IntegrationEvent(false, false)]
    local procedure OnPostDeferralOnBeforeInsertGLEntryForGLAccount(GenJournalLine: Record "Gen. Journal Line"; DeferralLine: Record "Deferral Line"; var GLEntry: Record "G/L Entry"; GLRegisterNo: Integer)
    begin
    end;
