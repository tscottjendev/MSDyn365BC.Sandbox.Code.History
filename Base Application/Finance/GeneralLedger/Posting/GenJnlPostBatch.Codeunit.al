...
#pragma warning restore AA0074
    ...
    begin
        ...
        WHTGenJournalLine.SetRange("Journal Template Name", GenJnlLine."Journal Template Name");
        WHTGenJournalLine.SetRange("Journal Batch Name", GenJnlLine."Journal Batch Name");
        WHTGenJournalLine.SetRange("Is WHT", true);
        WHTGenJournalLine.SetRange("System-Created Entry", true);

        GenJnlLine.SetRange("Is WHT", false);
        ...
        repeat
            ...
            WHTGenJournalLine.SetFilter("Line No.", '>%1', WHTGenJournalLine."Line No.");
