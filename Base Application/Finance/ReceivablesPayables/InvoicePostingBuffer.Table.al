...
table 55 "Invoice Posting Buffer"
{
    ...
    begin
        ...
        if Find() then begin
            ...
            "Non Deductible VAT Amt." += InvoicePostingBuffer."Non Deductible VAT Amt.";
            "Non Ded. VAT Amt. (ACY)" += InvoicePostingBuffer."Non Ded. VAT Amt. (ACY)";
    ...
    procedure SetNDAmounts(TotalNDAmount: Decimal; TotalNDAmountACY: Decimal)
    begin
