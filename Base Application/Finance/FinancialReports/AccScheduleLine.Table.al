...
table 85 "Acc. Schedule Line"
{
    ...
    fields
    {
        ...
        field(10700; Type; Option)
        {
            Caption = 'Type';
            OptionCaption = ' ,Debit,Credit,Assets,Liabilities,Capital';
            OptionMembers = " ",Debit,Credit,Assets,Liabilities,Capital;
        ...
        field(10701; Indentation; Integer)
        {
            BlankNumbers = BlankZero;
            Caption = 'Indentation';
            MinValue = 0;
        }
        field(10702; "Positive Only"; Boolean)
        {
            Caption = 'Positive Only';
        }
        field(10703; "Reverse Sign"; Boolean)
        {
