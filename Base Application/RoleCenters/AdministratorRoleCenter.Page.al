    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group("VAT Registration Numbers")
            {
                ...
                action("Digital Audit Definition Groups")
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Digital Audit Definition Groups';
                    RunObject = Page "Data Exports";
                    ToolTip = 'View or edit groups of record definitions that represent data sets to be exported.';
                }
            }
            group("Analysis View")
            {
