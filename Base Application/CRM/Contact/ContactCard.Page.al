...
page 5050 "Contact Card"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Trade Register"; Rec."Trade Register")
                {
                    ...
                    ToolTip = 'Specifies the contact''s RCS number.';
                }
                ...
                field("Legal Form"; Rec."Legal Form")
                {
                    ...
                    ToolTip = 'Specifies the legal form for the contact, for example, SA or SARL.';
                }
                field("Stock Capital"; Rec."Stock Capital")
                {
                    ApplicationArea = Basic, Suite;
                    Enabled = "Stock CapitalEnable";
                    ToolTip = 'Specifies the stock capital for the contact.';
                }
    ...
    begin
        ...
        "Trade RegisterEnable" := Rec.Type = Rec.Type::Company;
        "APE CodeEnable" := Rec.Type = Rec.Type::Company;
        "Legal FormEnable" := Rec.Type = Rec.Type::Company;
        "Stock CapitalEnable" := Rec.Type = Rec.Type::Company;
