...
page 5050 "Contact Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("Foreign Trade")
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Enabled = EnterpriseNoEnable;
                    ToolTip = 'Specifies the contact''s enterprise number.';
                }
            }
    ...
    begin
        ...
        EnterpriseNoEnable := Rec.Type = Rec.Type::Company;
