    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("SAT Postal Code"; Rec."SAT Postal Code")
                {
                    ApplicationArea = Basic, Suite;
            ...
            {
                Caption = 'Tax';
                field("QST Registration No."; Rec."QST Registration No.")
                {
                ...
                field("Software Identification Code"; Rec."Software Identification Code")
                {
                    ApplicationArea = BasicCA;
