...
page 1 "Company Information"
{
    ...
    layout
    {
        area(content)
        {
            ...
            {
                Caption = 'Other';
                field("Intrastat Establishment No."; Rec."Intrastat Establishment No.")
                {
                    ApplicationArea = BasicEU;
                    ToolTip = 'Specifies the Intrastat Establishment No. of your company.';
                }
                field("Enterprise No."; Rec."Enterprise No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the company''s enterprise number.';
                }
                field("Branch No."; Rec."Branch No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the branch number for subsidiary companies in Belgium.';
                }
            }
