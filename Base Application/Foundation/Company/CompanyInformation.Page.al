    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the identification number of the company''s tax representative.';
                }
                field("Transmission Intermediary No."; Rec."Transmission Intermediary No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the vendor that acts as your intermediary for VAT reports.';
                }
            ...
            group(Payments)
            {
                ...
                field("SIA Code"; Rec."SIA Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the company''s identification number assigned by the bank.';
                }
                field("Authority County"; Rec."Authority County")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the company''s county that is associated with the bank.';
                }
                field("Autoriz. No."; Rec."Autoriz. No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the company''s authorization number assigned by the bank to make payments.';
                }
                field("Autoriz. Date"; Rec."Autoriz. Date")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the date when the bank has assigned the authorization.';
                }
                field("Signature on Bill"; Rec."Signature on Bill")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the signature that will appear on the Bank Receipt or Vendor Bill List file.';
                }
                field(IBAN; Rec.IBAN)
                {
                    ApplicationArea = Basic, Suite;
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies your Italian bank information that identifies the bank account.';
                }
            ...
            group(Administration)
            {
                ...
                field("FD Address"; Rec."FD Address")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the (fiscal) address for the company''s registered office.';
                }
                field("FD Post Code"; Rec."FD Post Code")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the (fiscal) postal code for the company''s registered office.';
                }
                field("FD City"; Rec."FD City")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the (fiscal) city for the company''s registered office.';
                }
                field("FD County"; Rec."FD County")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the (fiscal) county for the company''s registered office.';
                }
                field("REA No."; Rec."REA No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the company''s identification number assigned by the Chamber of Commerce in the county where the company resides.';
                }
                field("Register Company No."; Rec."Register Company No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the company''s registration code from the Chamber of Commerce Register subscription.';
                }
                field("Registry Office Province"; Rec."Registry Office Province")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the province.';
                }
                ...
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the code that identifies the office.';
                }
                field("General Manager No."; Rec."General Manager No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the identification number of the company''s general manager.';
                }
                field("Accounting Manager No."; Rec."Accounting Manager No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the identification number of the company''s accounting manager.';
                }
                field("Finance Manager No."; Rec."Finance Manager No.")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the identification number of the company''s finance manager.';
                }
                field("Shareholder Status"; Rec."Shareholder Status")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the company is owned by a single shareholder or more shareholders.';
                }
                field("Liquidation Status"; Rec."Liquidation Status")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies if the company is in liquidation.';
                }
                field("Paid-In Capital"; Rec."Paid-In Capital")
                {
                    ApplicationArea = Basic, Suite;
                    ToolTip = 'Specifies the paid-in capital that is exported in the CapitaleSociale node of the electronic invoice XML file.';
                }
            }
    ...
    actions
    {
        area(navigation)
        {
            ...
            action("Payment &Days")
            {
                ...
                Image = PaymentDays;
                RunObject = Page "Fixed Due Dates";
                RunPageLink = Type = const(Company),
                              Code = const('');
                ToolTip = 'View the list of fixed due dates.';
            }
            action("O&fficials")
            {
                ApplicationArea = Basic, Suite;
                ...
                ToolTip = 'View the list of company officials.';
            }
