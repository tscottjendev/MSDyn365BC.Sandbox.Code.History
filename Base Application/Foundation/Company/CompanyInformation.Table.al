...
#pragma warning restore AS0086
...
#endif
        field(11300; "Intrastat Establishment No."; Text[2])
        {
            Caption = 'Intrastat Establishment No.';
        }
        field(11301; "Enterprise No. Accountant"; Text[50])
        {
            Caption = 'Enterprise No. Accountant';
        }
        field(11302; "XML Seq. No. Annual Listing"; Integer)
        {
            Caption = 'XML Seq. No. Annual Listing';
        }
        field(11303; "XML Seq. No. EU Sales List"; Integer)
        {
            Caption = 'XML Seq. No. EU Sales List';
        }
        field(11304; "XML Seq. No. VAT Declaration"; Integer)
        {
        ...
        field(11310; "Enterprise No."; Text[50])
        {
            ...
            begin
                ...
                if ("Enterprise No. Accountant" = '') or ("Enterprise No. Accountant" = xRec."Enterprise No. Accountant") then
                    "Enterprise No. Accountant" := "Enterprise No.";
            end;
        }
        field(11311; "Branch No."; Text[20])
        {
            ...
            begin
                if "Branch No." <> '' then
                    if not EnterpriseNoMgt.MOD97Check("Branch No.") then
    ...
    var
        ...
        Text11301: Label 'You must use %1 for Belgian companies.';
        Text11302: Label 'You cannot use %1 for foreign companies.';
...
#pragma warning restore AA0470
    ...
    begin
        if CountryRegion.DetermineCountry("Country/Region Code") then
            exit("Enterprise No.");
    ...
    begin
        ...
        if CountryRegion.DetermineCountry("Country/Region Code") then begin
