...
#pragma warning restore AA0074
    ...
    begin
        if not (SourceCodeSetup.FindFirst() or SourceCode.FindFirst()) then begin
            ...
            InsertSourceCode(SourceCodeSetup."Delivery Reminder", Text1140004, Text1140005);
    ...
    begin
        ...
        ReportSelectionMgt.InitDACHReportSelection();
    ...
    begin
        if not BankExportImportSetup.FindFirst() then begin
            ...
            InsertBankExportImportSetup(SEPA_CT_APCCodeTxt, SEPA_CT_APCNameTxt, BankExportImportSetup.Direction::Export,
