...
#pragma warning restore AA0074
        ...
        EPayCodeTxt: Label 'E-PAY';
        EPayNameTxt: Label 'Electronic Payment';
        POExport34Txt: Label 'Payment order - Export N34';
        POExport34_1Txt: Label 'PO - Export N34.1';
        FactTxt: Label 'Fact', Comment = 'Factoring';
        BillGroupExportTxt: Label 'Bill Group - Export factoring';
        BillGroupN58Txt: Label 'Bill Group - Export N58';
        BillGroupN19Txt: Label 'Bill Group - Export N19';
        BillGroupN32Txt: Label 'Bill Group - Export N32';
...
#pragma warning restore AA0074
        ...
        Text1100000: Label 'B';
        Text1100001: Label 'Our Bill';
        Text1100002: Label 'OI';
        Text1100003: Label 'Our Invoice';
        Text1100004: Label 'OCM';
        Text1100005: Label 'Our Credit Memo';
        Text1100006: Label 'YI';
    ...
    begin
        if not BankExportImportSetup.FindFirst() then begin
            ...
            InsertBankExportImportSetup(EPayCodeTxt, EPayNameTxt, BankExportImportSetup.Direction::Export,
              CODEUNIT::"Create Electronic Payments", 0, 0);
            InsertBankExportImportSetup('N34', POExport34Txt, BankExportImportSetup.Direction::Export,
              CODEUNIT::"Payment order - Export N34", 0, 0);
            InsertBankExportImportSetup('N34.1', POExport34_1Txt, BankExportImportSetup.Direction::Export,
              CODEUNIT::"PO - Export N34.1", 0, 0);
            InsertBankExportImportSetup(FactTxt, BillGroupExportTxt, BankExportImportSetup.Direction::Export,
              CODEUNIT::"Bill group - Export factoring", 0, 0);
            InsertBankExportImportSetup('N58', BillGroupN58Txt, BankExportImportSetup.Direction::Export,
              CODEUNIT::"Bill group - Export N58", 0, 0);
            InsertBankExportImportSetup('N19', BillGroupN19Txt, BankExportImportSetup.Direction::Export,
              CODEUNIT::"Bill group - Export N19", 0, 0);
            InsertBankExportImportSetup('N32', BillGroupN32Txt, BankExportImportSetup.Direction::Export,
              CODEUNIT::"Bill group - Export N32", 0, 0);
