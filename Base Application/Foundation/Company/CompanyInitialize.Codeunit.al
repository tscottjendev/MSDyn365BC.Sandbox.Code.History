...
#pragma warning restore AA0074
        ...
        DomiciliationCodeTxt: Label 'DOM', Comment = 'Domiciliation';
        DomiciliationNameTxt: Label 'File Domiciliation';
...
#pragma warning restore AA0074
    ...
    begin
        ...
        if not EBSetup.FindFirst() then begin
            EBSetup.Init();
            EBSetup.Insert();
        end;
    ...
    begin
        if not (SourceCodeSetup.FindFirst() or SourceCode.FindFirst()) then begin
            ...
            InsertSourceCode(SourceCodeSetup."Financial Journal", Text11300, PageName(PAGE::"Financial Journal"));
    ...
    begin
        if not BankExportImportSetup.FindFirst() then begin
            ...
            InsertBankExportImportSetup(DomiciliationCodeTxt, DomiciliationNameTxt, BankExportImportSetup.Direction::Export,
              CODEUNIT::"File Domiciliations", 0, 0);
