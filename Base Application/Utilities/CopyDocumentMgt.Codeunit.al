                    ...
                    begin
                        ...
                        if ToSalesHeader."Document Type" = ToSalesHeader."Document Type"::"Credit Memo" then
                            SalesTaxAmountDifference.CopyTaxDifferenceRecords(
                              ...
                              SalesTaxAmountDifference."Document Type"::Invoice, FromDocNo,
                              SalesTaxAmountDifference."Document Product Area"::Sales,
                              ToSalesHeader."Document Type".AsInteger(), ToSalesHeader."No.");
                    end;
                ...
                begin
                    ...
                    if ToPurchHeader."Document Type" = ToPurchHeader."Document Type"::"Credit Memo" then
                        SalesTaxAmountDifference.CopyTaxDifferenceRecords(
                          ...
                          ToPurchHeader."Document Type".AsInteger(), ToPurchHeader."No.");
                end;
