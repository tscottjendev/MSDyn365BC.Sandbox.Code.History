...
#pragma warning restore AA0074
    ...
    begin
        ...
        ToSalesHeader.Validate("Operation Type");
    ...
    begin
        ...
        ToPurchHeader.Validate("Operation Type");
    ...
    begin
        ...
        ToSalesLine.ValidateIncludeInDT();
        ToSalesLine."Automatically Generated" := FromSalesLine."Automatically Generated";
        ...
        if not IsHandled then begin
            ...
            if (FromSalesLine.Type <> FromSalesLine.Type::" ") and (FromSalesLine."No." <> '') then begin
                ...
                if ToSalesLine."Document Type" in [
                                                   ToSalesLine."Document Type"::Order, ToSalesLine."Document Type"::Invoice,
                                                   ToSalesLine."Document Type"::"Credit Memo"]
                then
                    if VATPostingSetup.IsEUService(ToSalesLine."VAT Bus. Posting Group", ToSalesLine."VAT Prod. Posting Group") then
                        ToSalesLine.Validate("Service Tariff No.", FromSalesLine."Service Tariff No.");
    ...
    begin
        ...
        if CustLedgEntry.FindFirst() then begin
            ...
            ToSalesHeader."Applies-to Occurrence No." := CustLedgEntry."Document Occurrence";
    ...
    begin
        ...
        if not IsHandled then begin
            ...
            if VendLedgEntry.FindFirst() then begin
                ...
                ToPurchHeader."Applies-to Occurrence No." := VendLedgEntry."Document Occurrence";
