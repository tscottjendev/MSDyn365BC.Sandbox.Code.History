                    ...
                    if ProdOrderLine.Find('-') then begin
                        ...
                        repeat
                            BaseQtyToPurch :=
                                ...
                                (MfgCostCalcMgt.CalcOutputQtyBaseOnPurchOrder(ProdOrderLine, "Prod. Order Routing Line") +
                                 MfgCostCalcMgt.CalcActOutputQtyBase(ProdOrderLine, "Prod. Order Routing Line"));
