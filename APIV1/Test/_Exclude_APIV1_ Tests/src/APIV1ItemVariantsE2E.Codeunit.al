codeunit 139739 "APIV1 - Item Variants E2E"
{
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL('', PAGE::"APIV1 - Item Variants", '');
    ...
    begin
        ...
        TargetURL := LibraryGraphMgt.CreateTargetURL(ItemVariant.SystemId, PAGE::"APIV1 - Item Variants", ServiceNameTxt);
    ...
    var
        ...
        ItemId: Text;
    begin
        ExpectedItemId := LowerCase(LibraryGraphMgt.StripBrackets(Format(ExpectedItemId)));
