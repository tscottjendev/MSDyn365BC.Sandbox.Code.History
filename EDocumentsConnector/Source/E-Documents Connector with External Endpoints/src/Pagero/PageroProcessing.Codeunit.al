...
codeunit 6369 "Pagero Processing"
{
    ...
    var
        ...
        Items: JsonArray;
        ItemsToken, ItemMetaDataToken : JsonToken;
        Item: Text;
        I: Integer;
    begin
        ...
        JsonObject.Get('items', ItemsToken);
        Items := ItemsToken.AsArray();

        for I := 1 to Items.Count() do begin
            Clear(TempBlob);
            TempBlob.CreateOutStream(OutStream, TextEncoding::UTF8);
            Items.Get(I - 1, ItemMetaDataToken); // JSON arrays are 0 based
            ItemMetaData := ItemMetaDataToken.AsObject();
    ...
    var
        ...
        DocumentIdToken, FileIdToken : JsonToken;
    ...
    begin
        ...
        ItemObject.Get('id', DocumentIdToken);
        ItemObject.Get('fileId', FileIdToken);
        DocumentId := DocumentIdToken.AsValue().AsText();
        FileId := FileIdToken.AsValue().AsText();
        ...
        case RelatedRecordRef.Number of
            database::"Purchase Header":
                begin
                    ...
                    if EDocument.SystemId <> PurchaseHeader."E-Document Link" then
                        Error(CannotRejectErr, PurchaseHeader.SystemId, PurchaseHeader."E-Document Link");
    ...
    var
        ...
        CannotRejectErr: Label 'Failed to delete purchase document %1 as it is currently linked to another E-Document %2', Comment = '%1 - Purchase header system id, %2 - E-Document system id';
