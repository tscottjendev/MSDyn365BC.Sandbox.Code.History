...
codeunit 131902 "Library - Service"
{
    ...
    var
        NoSeries: Record Microsoft.Foundation.NoSeries."No. Series";
    ...
    begin
        ...
        ServiceHeader.Validate("Operation Occurred Date", ServiceHeader."Posting Date");
        if (ServiceHeader."Document Type" = ServiceHeader."Document Type"::"Credit Memo") and (ServiceHeader."Operation Type" = '') then
            ServiceHeader.Validate("Operation Type", LibraryERM.GetDefaultOperationType(ServiceHeader."Customer No.", DATABASE::Customer));
        ServiceHeader.Modify(true);
