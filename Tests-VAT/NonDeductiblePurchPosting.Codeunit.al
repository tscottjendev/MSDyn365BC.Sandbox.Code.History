codeunit 134283 "Non-Deductible Purch. Posting"
{
    ...
    begin
        ...
        PurchaseHeader."Check Total" := Amount;
        ...
        ValueEntry[1].SetRange("Document No.", PurchaseHeader."Last Posting No.");
        ValueEntry[1].SetRange("Item No.", ItemNo);
        ValueEntry[1].FindFirst();

        // [WHEN] Find Value Entry of Item Charge.
        ValueEntry[2].SetRange("Document No.", PurchaseHeader."Last Posting No.");
