...
codeunit 139694 "Usage Based Rebilling Test"
{
    ...
    begin
        ...
        // [THEN] Check service commitment
        ServiceCommitment.Get(UsageDataBilling."Service Commitment Entry No.");
    ...
    begin
        ...
        UsageDataGenericImport."Subscription ID" := GetSubscriptionId();
        ...
        GenericUsageDataImport.CreateUsageDataSubscription(UsageDataGenericImport."Subscription ID", UsageDataGenericImport."Customer ID",
    ...
    begin
        ...
        // Update service commitments
        ServiceCommitmentGlobal.SetRange("Service Object No.", ServiceObject."No.");
        ...
        repeat
            ...
            ServiceCommitmentGlobal.Validate("Service Start Date", ServiceAndCalculationStartDate);
    ...
    var
        ...
        ServiceCommitmentGlobal: Record "Service Commitment";
