...
codeunit 139914 "Imp. Service And Contract Test"
{
    ...
    begin
        ...
        Assert.AreEqual(2, ImportedCustomerContract.Count(), 'Not all Imported Customer Contract lines are processed.');
    end;
    ...
    var
        ...
        UnexpectedServCommErr: Label 'Unexpected Service Commitment created on Create Service Object.', Locked = true;
        i: Integer;
    begin
        ...
        Assert.AreEqual(4, ImportedServiceObject.Count(), 'Unexpected number of Imported Service Objects.');
    ...
    begin
        ...
        Assert.IsTrue(CustomerContractLine.IsEmpty(), 'Customer Contract Line should be empty.');
        VendorContractLine.SetRange("Contract No.", VendorContract."No.");
        Assert.IsTrue(VendorContractLine.IsEmpty(), 'Vendor Contract Line should be empty.');
        ...
        Assert.AreEqual(2, CustomerContractLine.Count(), 'Customer Contract Line not found.');
        Assert.AreEqual(2, VendorContractLine.Count(), 'Vendor Contract Line not found.');
        ...
        Assert.IsFalse(ServiceObject."Archived Service Commitments", 'Archived Service Commitment should not be created during Import of Service Commitments.');
    end;
