...
codeunit 8056 "Subscription Notifications"
{
    ...
    begin
        ...
        OnBeforeCopySellToCustomerAddressFieldsFromSubscriptionHeader(ModifyCustomerAddressNotification, ServiceObject);
    ...
    begin
        ...
        OnBeforeCopyBillToCustomerAddressFieldsFromSubscriptionHeader(ModifyCustomerAddressNotification, ServiceObject);
    ...
    local procedure GetServiceObjectFullSellToAddress(ServiceObject: Record "Subscription Header"): Text
    var
        AddressArray: array[7] of Text;
    begin
    ...
    local procedure GetServiceObjectFullBillToAddress(ServiceObject: Record "Subscription Header"): Text
    var
        AddressArray: array[7] of Text;
    begin
