...
codeunit 8108 "Create Sub. Bill. GL Account"
{
    ...
    var
        ...
        CustomerContractsRevenueLbl: Label 'Customer Contracts Revenue', MaxLength = 100;
        CustomerContractsDeferralsLbl: Label 'Customer Contract Deferrals', MaxLength = 100;
        VendorContractsCostLbl: Label 'Vendor Contracts Cost', MaxLength = 100;
        VendorContractsDeferralsLbl: Label 'Vendor Contract Deferrals', MaxLength = 100;
