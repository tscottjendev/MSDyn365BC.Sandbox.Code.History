...
codeunit 8105 "Contoso Subscription Billing"
{
    ...
    Permissions =
        ...
        tabledata "Service Commitment Template" = rim,
        tabledata "Service Commitment Package" = rim,
        tabledata "Service Comm. Package Line" = rim,
        tabledata "Item Serv. Commitment Package" = rim,
        tabledata "Usage Data Supplier" = rim,
        tabledata "Usage Data Supplier Reference" = rim,
        tabledata "Generic Import Settings" = rim,
        tabledata "Service Object" = rim,
    ...
    begin
        ...
        PriceUpdateTemplate.WriteFilter(PriceUpdateTemplate.FieldNo("Contract Filter"), FilterText);
    end;
    ...
    begin
        ...
        GeneralPostingSetup.Validate("Customer Contract Account", CustomerContractAccount);
        GeneralPostingSetup.Validate("Cust. Contr. Deferral Account", CustContrDeferralAccount);

        GeneralPostingSetup.Validate("Vendor Contract Account", VendorContractAccount);
        GeneralPostingSetup.Validate("Vend. Contr. Deferral Account", VendContrDeferralAccount);
    ...
    begin
        ...
        Item.Get(ItemNo);
        Item.Validate("Service Commitment Option", ServiceCommitmentOption);
        Item.Modify(true);
    end;
    ...
    begin
        ServiceCommPackageLine.SetRange("Package Code", PackageCode);
        ...
        ServiceCommPackageLine.Validate("Package Code", PackageCode);
    ...
    begin
        ...
        GenericImportSettings.Validate("Create Subscriptions", CreateSubscriptions);
    ...
    begin
        ...
        ServiceObject.Validate("Quantity Decimal", Quantity);
        ServiceObject.Modify(true);
    end;
    ...
    begin
        ServiceCommitment.SetRange("Service Object No.", ObjectNo);
        ServiceCommitment.SetRange("Package Code", PackageCode);
    ...
    begin
        ...
        ServiceCommitment.FindFirst();
        ServiceCommitment."Contract No." := ContractNo;
    ...
    begin
        ...
        UsageDataSubscription.SetRange("Service Object No.", ServiceObjectNo);
        ...
        UsageDataSubscription.Validate("Connect to Service Object No.", ServiceObjectNo);
