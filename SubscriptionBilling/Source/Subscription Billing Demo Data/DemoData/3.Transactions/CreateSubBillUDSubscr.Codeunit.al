...
codeunit 8120 "Create Sub. Bill. UD Subscr."
{
    ...
    begin
        ContosoSubscriptionBilling.InsertUsageDataSubscription(CreateSubBillSupplier.Generic(), CommonCustomer.DomesticCustomer1(), CustomerIDTok, CreateSubBillServObj.SOB100004(), ProductIDTok, ProductNameLbl, 3,
    ...
    var
        ...
        ProductIDTok: Label 'prd-gdi-1105-001', MaxLength = 80, Locked = true;
