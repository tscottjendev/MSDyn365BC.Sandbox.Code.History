...
tableextension 6230 "Sust. Resource" extends Resource
{
    fields
    {
    ...
    local procedure ClearDefaultEmissionInformation(var Resource: Record Resource)
    begin
        Resource.Validate("Default N2O Emission", 0);
        Resource.Validate("Default CH4 Emission", 0);
        Resource.Validate("Default CO2 Emission", 0);
    end;
}