...
tableextension 6231 "Sust. Work Center" extends "Work Center"
{
    fields
    {
    ...
    local procedure ClearDefaultEmissionInformation(var WorkCenter: Record "Work Center")
    begin
        WorkCenter.Validate("Default N2O Emission", 0);
        WorkCenter.Validate("Default CH4 Emission", 0);
        WorkCenter.Validate("Default CO2 Emission", 0);
    end;
}