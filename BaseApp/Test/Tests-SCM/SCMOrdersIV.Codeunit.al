codeunit 137156 "SCM Orders IV"
{
    ...
    var
        SalesPrices: TestPage "Sales Prices";
    begin
        // Setup: Create Customer and open Sales Prices page from Customer Card.
        Initialize();
        CreateCustomerAndOpenSalesPricesPageFromCustomerCard(SalesPrices);

        // Exercise: Enter Negative Minimum Quantity on Sales Prices Page.
        asserterror SalesPrices."Minimum Quantity".SetValue(-LibraryRandom.RandDec(10, 2));
    ...
    [Test]
    [Scope('OnPrem')]
    procedure SalesPriceNegativeUnitPriceError()
    var
        SalesPrices: TestPage "Sales Prices";
    begin
        // Setup: Create Customer and open Sales Prices page from Customer Card.
        ...
        // Exercise: Enter Negative Unit Price on Sales Prices Page.
        asserterror SalesPrices."Unit Price".SetValue(-LibraryRandom.RandDec(10, 2));  // Negative value required.
    ...
    [Test]
    [Scope('OnPrem')]
    procedure SalesPriceStartingDateAfterEndingDateError()
    var
        SalesPrices: TestPage "Sales Prices";
    begin
        // Setup: Create Customer and open Sales Prices page from Customer Card.
        ...
        // Exercise: Enter Ending Date Earlier to Starting Date on Sales Prices Page.
        SalesPrices."Starting Date".SetValue(CalcDate('<' + Format(LibraryRandom.RandInt(5)) + 'D>', WorkDate()));
        asserterror SalesPrices."Ending Date".SetValue(WorkDate());  // Ending Date is Earlier than Starting Date.
    ...
    [Test]
    [Scope('OnPrem')]
    procedure SalesLineDiscountNegativeQuantityError()
    var
        SalesLineDiscounts: TestPage "Sales Line Discounts";
    begin
        // [FEATURE] [UI] [Discount] [Line Discount]
        ...
        // [GIVEN] "Sales Line Discounts" page opened from customer Card
        CreateCustomerAndOpenSalesLineDiscountsPageFromCustomerCard(SalesLineDiscounts);

        // [WHEN] Set "Minimum Quantity" = -1
        asserterror SalesLineDiscounts."Minimum Quantity".SetValue(-LibraryRandom.RandDec(10, 2));

        // [THEN] There is an error "The value must be greater than or equal to 0"
        Assert.ExpectedError(NegativeValueErr);
    end;

    [Test]
    [Scope('OnPrem')]
    procedure SalesLineDiscountNegativeLineDiscountError()
    var
        SalesLineDiscounts: TestPage "Sales Line Discounts";
    begin
        // [FEATURE] [UI] [Discount] [Line Discount]
        ...
        // [WHEN] Set "Line Discount %" = -1
        asserterror SalesLineDiscounts."Line Discount %".SetValue(-LibraryRandom.RandDec(10, 2));
    ...
    [Test]
    [Scope('OnPrem')]
    procedure SalesLineDiscountStartingDateAfterEndingDateError()
    var
        SalesLineDiscounts: TestPage "Sales Line Discounts";
    begin
        // [FEATURE] [UI] [Discount] [Line Discount]
        ...
        // [GIVEN] "Sales Line Discounts" page opened from customer Card
        CreateCustomerAndOpenSalesLineDiscountsPageFromCustomerCard(SalesLineDiscounts);
        // [GIVEN] Set "Starting Date" = 25-01-2018
        SalesLineDiscounts."Starting Date".SetValue(CalcDate('<' + Format(LibraryRandom.RandInt(5)) + 'D>', WorkDate()));

        // [WHEN] Set "Ending Date" = 24-01-2018
        asserterror SalesLineDiscounts."Ending Date".SetValue(WorkDate());

        // [THEN] There is an error "Starting Date cannot be after Ending Date"
        Assert.ExpectedError(StartingDateErr);
    end;

    [Test]
    [Scope('OnPrem')]
    procedure SalesLineDiscountSalesCodeFieldIsNotEditableForAllCustomersOption()
    var
        SalesLineDiscounts: TestPage "Sales Line Discounts";
        SalesType: Option Customer,"Customer Disc. Group","All Customers",Campaign;
    begin
        // [SCENARIO 201712] Page 7004 "Sales Line Discounts" field "Sales Code" is not editable in case of "Sales Type" = "All Customers"
        // [FEATURE] [UI] [Discount] [Line Discount]
        Initialize();
    ...
    begin
        ...
        CustomerCard."Line Discounts".Invoke();  // Open Sales Line Discount Page from Customer Card.
    end;

    local procedure CreateCustomerAndOpenSalesPricesPageFromCustomerCard(var SalesPrices: TestPage "Sales Prices")
    var
        Customer: Record Customer;
        CustomerCard: TestPage "Customer Card";
    begin
        ...
        SalesPrices.Trap();
        OpenCustomerCard(CustomerCard, Customer."No.");
        CustomerCard.Prices.Invoke();  // Open Sales Price Page from Customer Card.
    end;
